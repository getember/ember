...
<script lang="ts">
  ...
  import { Calendar, generateEventId } from '@digitranslab/calendar'
  import { VisibilityEditor } from '@digitranslab/calendar-resources'
  import calendar from '@digitranslab/calendar-resources/src/plugin'
  import { PersonAccount } from '@digitranslab/contact'
  import core, { AttachedData, Doc, Ref, SortingOrder, generateId, getCurrentAccount } from '@digitranslab/core'
  import { SpaceSelector, createQuery, getClient } from '@digitranslab/presentation'
  import tagsPlugin, { TagReference } from '@digitranslab/tags'
  import task, { makeRank } from '@digitranslab/task'
  import { StyledTextBox } from '@digitranslab/text-editor-resources'
  import { TimeEvents, ToDo, ToDoPriority, WorkSlot } from '@digitranslab/time'
  import { Button, Component, EditBox, IconClose, Label, Scroller } from '@digitranslab/ui'
