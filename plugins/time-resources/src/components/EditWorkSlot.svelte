...
<script lang="ts">
  ...
  import {
    ...
    VisibilityEditor,
    isReadOnly
  } from '@digitranslab/calendar-resources'
  import calendar from '@digitranslab/calendar-resources/src/plugin'
  import { DocumentUpdate } from '@digitranslab/core'
  ...
  import { Button, EditBox, Icon, IconClose, createFocusManager } from '@digitranslab/ui'
  import FocusHandler from '@digitranslab/ui/src/components/FocusHandler.svelte'
