...
-->
<script lang="ts">
  import type { ItemPresenter, ToDo } from '@digitranslab/time'
  import type { Class, Doc } from '@digitranslab/core'
  import type { ObjectPanel } from '@digitranslab/view'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Component, showPanel } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import time from '../plugin'
  import { DocReferencePresenter, getObjectLinkId } from '@digitranslab/view-resources'
