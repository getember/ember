<script lang="ts">
  import calendar, { Event } from '@digitranslab/calendar'
  import { DateRangeMode } from '@digitranslab/core'
  import { Icon } from '@digitranslab/ui'
  import DatePresenter from '@digitranslab/ui/src/components/calendar/DatePresenter.svelte'
  import ArrowRight from '@digitranslab/ui/src/components/icons/ArrowRight.svelte'
