...
<script lang="ts">
  ...
  import { Label, Separator, Scroller, NavItem, deviceOptionsStore as deviceInfo } from '@digitranslab/ui'
  import { ObjectPresenter, TreeNode } from '@digitranslab/view-resources'
