...
<script lang="ts">
  ...
  import { Component, resizeObserver } from '@digitranslab/ui'
  import { DocNavLink, ObjectPresenter } from '@digitranslab/view-resources'
  import { ItemPresenter } from '@digitranslab/time'
