...
-->
<script lang="ts">
  import calendar, { CalendarEventPresenter, Event } from '@digitranslab/calendar'
  import { EventPresenter, calendarByIdStore, isVisible } from '@digitranslab/calendar-resources'
  import { Doc } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Component, MILLISECONDS_IN_MINUTE, showPopup, tooltip } from '@digitranslab/ui'
  import view, { ObjectEditor } from '@digitranslab/view'
