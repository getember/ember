<script lang="ts">
  import calendar, { Calendar, Event, generateEventId, getAllEvents } from '@digitranslab/calendar'
  import { DayCalendar, calendarByIdStore, hidePrivateEvents } from '@digitranslab/calendar-resources'
  import { PersonAccount } from '@digitranslab/contact'
  import { Ref, SortingOrder, Timestamp, getCurrentAccount } from '@digitranslab/core'
...
>
  ...
  <div class="emberComponent-content__container">
    <DayCalendar
