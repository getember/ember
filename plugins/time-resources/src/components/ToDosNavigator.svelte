<script lang="ts">
  ...
  import { NavFooter } from '@digitranslab/workbench-resources'
  import tagsPlugin, { TagElement as TagElementType } from '@digitranslab/tags'
  import ui, {
    Label,
    Separator,
    NavItem,
...
>
  <div class="antiPanel-wrap__content emberNavPanel-container">
    ...
    <Scroller shrink>
      ...
      <div class="emberAccordionItem-container border" class:noBorder={tags.length === 0}>
        <Month
