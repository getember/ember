...
<script lang="ts">
  ...
  import calendar, { Calendar, generateEventId } from '@digitranslab/calendar'
  ...
  import { TagElement } from '@digitranslab/tags'
  import { Separator, defineSeparators, deviceOptionsStore as deviceInfo } from '@digitranslab/ui'
