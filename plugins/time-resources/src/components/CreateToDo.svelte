<script lang="ts">
  import { ActionIcon, IconAdd, showPopup, ModernEditbox, Spinner } from '@digitranslab/ui'
  import { SortingOrder, generateId, getCurrentAccount } from '@digitranslab/core'
  import { PersonAccount } from '@digitranslab/contact'
  import { TimeEvents, ToDoPriority } from '@digitranslab/time'
