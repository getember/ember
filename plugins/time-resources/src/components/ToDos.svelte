...
<script lang="ts">
  import type { DocumentQuery, Ref, WithLookup, IdMap } from '@digitranslab/core'
  import type { ToDo, WorkSlot } from '@digitranslab/time'
  import type { PersonAccount } from '@digitranslab/contact'
  import type { IntlString } from '@digitranslab/platform'
  import type { TagElement } from '@digitranslab/tags'
  import type { Project } from '@digitranslab/tracker'
  ...
  import { getCurrentAccount, toIdMap, SortingOrder } from '@digitranslab/core'
