...
-->
<script lang="ts">
  import { Visibility } from '@digitranslab/calendar'
  import calendar from '@digitranslab/calendar-resources/src/plugin'
  import core, { Class, Ref, Space, getCurrentAccount, Markup } from '@digitranslab/core'
  import { SpaceSelector, getClient, createQuery } from '@digitranslab/presentation'
  ...
  import { ModernEditbox, CheckBox, Component, IconClose, Label, Modal, Spinner, ButtonIcon } from '@digitranslab/ui'
  import { ToDo, ToDoPriority } from '@digitranslab/time'
