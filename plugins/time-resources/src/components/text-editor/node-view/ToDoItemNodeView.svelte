<script lang="ts">
  ...
  import { AssigneePopup, EmployeePresenter } from '@digitranslab/contact-resources'
  import { type Class, type Doc, type Ref, type Space, SortingOrder } from '@digitranslab/core'
  import { MessageBox, createQuery, getClient } from '@digitranslab/presentation'
  import { makeRank } from '@digitranslab/rank'
  import { NodeViewContent, NodeViewProps, NodeViewWrapper } from '@digitranslab/text-editor-resources'
  import time, { ToDo, ToDoPriority } from '@digitranslab/time'
  import { CheckBox, getEventPositionElement, showPopup } from '@digitranslab/ui'
