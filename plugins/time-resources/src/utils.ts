...
import core, { type Class, type Client, type Doc, type Ref } from '@digitranslab/core'
import time from '@digitranslab/time'
import { type TextEditorMode, type AnyExtension } from '@digitranslab/text-editor'
import { SvelteNodeViewRenderer } from '@digitranslab/text-editor-resources'
