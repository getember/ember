...
} from '@digitranslab/activity'
import { isReactionMessage } from '@digitranslab/activity-resources'
import { type Channel, type ChatMessage, type DirectMessage, type ThreadMessage } from '@digitranslab/chunter'
import contact, { getName, type Employee, type Person, type PersonAccount } from '@digitranslab/contact'
import { PersonIcon, employeeByIdStore, personIdByAccountId } from '@digitranslab/contact-resources'
import core, {
  getCurrentAccount,
  type Account,
  type Class,
...
import notification, { type DocNotifyContext, type InboxNotification } from '@digitranslab/notification'
import {
  InboxNotificationsClientImpl,
  isActivityNotification,
  isMentionNotification
} from '@digitranslab/notification-resources'
import { translate, type Asset, getMetadata } from '@digitranslab/platform'
import { getClient } from '@digitranslab/presentation'
import { type AnySvelteComponent, languageStore } from '@digitranslab/ui'
import { classIcon, getDocLinkTitle, getDocTitle } from '@digitranslab/view-resources'
import { get, writable, type Unsubscriber } from 'svelte/store'
import aiBot from '@digitranslab/ai-bot'
import { translate as aiTranslate } from '@digitranslab/ai-bot-resources'
