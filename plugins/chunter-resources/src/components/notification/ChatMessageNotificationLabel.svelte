...
-->
<script lang="ts">
  import { Label, tooltip } from '@digitranslab/ui'
  ...
  import { getDocLinkTitle, getDocTitle, ObjectIcon } from '@digitranslab/view-resources'
  import { ChatMessage, ThreadMessage } from '@digitranslab/chunter'
