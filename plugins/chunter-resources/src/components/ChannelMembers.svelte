...
<script lang="ts">
  ...
  import { ButtonIcon, IconDelete, ModernButton, Scroller } from '@digitranslab/ui'
  import { IconAddMember, personByIdStore, UserDetails } from '@digitranslab/contact-resources'
