...
-->
<script lang="ts">
  import { ActivityExtension as ActivityExtensionComponent } from '@digitranslab/activity-resources'
  import { Class, Doc, Ref } from '@digitranslab/core'
  import activity, { ActivityExtension } from '@digitranslab/activity'
  import { getClient } from '@digitranslab/presentation'
  import { AnySvelteComponent, Icon, Label } from '@digitranslab/ui'
