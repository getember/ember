...
-->
<script lang="ts">
  import core, { Doc, generateId, getCurrentAccount, Ref, Space, Timestamp, Tx, TxCUD } from '@digitranslab/core'
  import activity, { ActivityMessage } from '@digitranslab/activity'
  import { ModernButton, Scroller } from '@digitranslab/ui'
  import { addTxListener, getClient, removeTxListener } from '@digitranslab/presentation'
  import { ActivityMessagePresenter, canGroupMessages, messageInFocus } from '@digitranslab/activity-resources'
