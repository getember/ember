...
<script lang="ts">
  ...
  import { Breadcrumbs, location as locationStore, Header, BreadcrumbItem, Loading } from '@digitranslab/ui'
  import { createEventDispatcher, onDestroy } from 'svelte'
  import activity, { ActivityMessage, DisplayActivityMessage } from '@digitranslab/activity'
