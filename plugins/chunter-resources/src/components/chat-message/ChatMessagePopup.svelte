...
<script lang="ts">
  ...
  import { Doc, Ref, SortingOrder } from '@digitranslab/core'
  ...
  import { closeTooltip, Label, Lazy, Spinner, resizeObserver, MiniToggle } from '@digitranslab/ui'
  import { ObjectPresenter, DocNavLink } from '@digitranslab/view-resources'
  import { canGroupMessages } from '@digitranslab/activity-resources'
