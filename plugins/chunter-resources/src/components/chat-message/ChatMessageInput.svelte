...
<script lang="ts">
  ...
  import chunter, { ChatMessage, ChunterEvents, ThreadMessage, TypingInfo } from '@digitranslab/chunter'
  import { Class, Doc, generateId, Ref, type CommitResult, getCurrentAccount } from '@digitranslab/core'
  import { createQuery, DraftController, draftsStore, getClient } from '@digitranslab/presentation'
  import { EmptyMarkup, isEmptyMarkup } from '@digitranslab/text'
  import { createEventDispatcher } from 'svelte'
  import { getObjectId } from '@digitranslab/view-resources'
  import { ThrottledCaller } from '@digitranslab/ui'
  import { getSpace } from '@digitranslab/activity-resources'
