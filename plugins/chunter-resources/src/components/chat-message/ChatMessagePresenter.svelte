...
-->
<script lang="ts">
  import contact, { Person, PersonAccount } from '@digitranslab/contact'
  import { personAccountByIdStore, personByIdStore } from '@digitranslab/contact-resources'
  import { Class, Doc, getCurrentAccount, Markup, Ref, Space, WithLookup } from '@digitranslab/core'
  import { getClient, MessageViewer } from '@digitranslab/presentation'
  import { AttachmentDocList, AttachmentImageSize } from '@digitranslab/attachment-resources'
  import { getDocLinkTitle } from '@digitranslab/view-resources'
  import { Action, Button, IconEdit, ShowMore } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import activity, { ActivityMessage, ActivityMessageViewType, DisplayActivityMessage } from '@digitranslab/activity'
  import { ActivityDocLink, ActivityMessageTemplate, MessageInlineAction } from '@digitranslab/activity-resources'
  import chunter, { ChatMessage, ChatMessageViewlet, InlineButton } from '@digitranslab/chunter'
  import { Attachment } from '@digitranslab/attachment'
  import { EmptyMarkup } from '@digitranslab/text'
