...
<script lang="ts">
  ...
  import { AttachmentPresenter, FileDownload } from '@digitranslab/attachment-resources'
  import { ChunterSpace } from '@digitranslab/chunter'
  import { Doc, SortingOrder, getCurrentAccount, type WithLookup } from '@digitranslab/core'
  import { createQuery, getClient, getFileUrl } from '@digitranslab/presentation'
  import { Icon, IconMoreV, Label, Menu, getCurrentResolvedLocation, navigate, showPopup } from '@digitranslab/ui'
