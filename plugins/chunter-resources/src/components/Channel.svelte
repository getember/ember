...
-->
<script lang="ts">
  import { Doc, getCurrentAccount, Ref } from '@digitranslab/core'
  import notification, { DocNotifyContext } from '@digitranslab/notification'
  import activity, { ActivityMessage, WithReferences } from '@digitranslab/activity'
  import { getClient, isSpace } from '@digitranslab/presentation'
  import { getMessageFromLoc, messageInFocus } from '@digitranslab/activity-resources'
  import { location as locationStore } from '@digitranslab/ui'
