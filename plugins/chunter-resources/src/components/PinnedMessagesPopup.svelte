...
<script lang="ts">
  ...
  import { ActivityMessagePresenter, sortActivityMessages } from '@digitranslab/activity-resources'
  import { ActionIcon, IconClose, Loading } from '@digitranslab/ui'
  import { createEventDispatcher } from 'svelte'
  import { ThreadMessage } from '@digitranslab/chunter'
  import { Class, Doc, Ref, SortingOrder, Space } from '@digitranslab/core'
