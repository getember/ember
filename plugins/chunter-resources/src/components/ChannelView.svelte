...
-->
<script lang="ts">
  import core, { Doc, getCurrentAccount, Ref, Space } from '@digitranslab/core'
  import {
    defineSeparators,
    getCurrentLocation,
    Label,
  ...
  import { Channel, ObjectChatPanel } from '@digitranslab/chunter'
  import view from '@digitranslab/view'
  import { messageInFocus } from '@digitranslab/activity-resources'
