...
-->
<script lang="ts">
  import { Button, eventToHTMLElement, IconFilter, showPopup } from '@digitranslab/ui'
  import { Ref } from '@digitranslab/core'
  import activity, { ActivityMessagesFilter } from '@digitranslab/activity'
  import view from '@digitranslab/view-resources/src/plugin'
  import { getClient } from '@digitranslab/presentation'
  import { ActivityMessagesFilterPopup } from '@digitranslab/activity-resources'
