...
-->
<script lang="ts">
  import { AccountRole, Doc, getCurrentAccount, hasAccountRole } from '@digitranslab/core'
  import { Scroller, SearchEdit, Label, ButtonIcon, IconAdd, showPopup, Menu } from '@digitranslab/ui'
  import { DocNotifyContext } from '@digitranslab/notification'
  import { SpecialNavModel } from '@digitranslab/workbench'
  import { NavLink } from '@digitranslab/view-resources'
  import { TreeSeparator, NavFooter } from '@digitranslab/workbench-resources'
...
<div class="emberNavPanel-header" class:withButton={hasAccountRole(getCurrentAccount(), AccountRole.User)}>
