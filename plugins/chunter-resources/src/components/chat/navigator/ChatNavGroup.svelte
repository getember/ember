...
<script lang="ts">
  ...
  import core, { Class, Doc, groupByArray, reduceCalls, Ref, Space } from '@digitranslab/core'
  ...
  import { createQuery, getClient, LiveQuery } from '@digitranslab/presentation'
  import { Action } from '@digitranslab/ui'
