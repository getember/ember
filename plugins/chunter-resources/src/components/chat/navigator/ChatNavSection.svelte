...
<script lang="ts">
  ...
  import { personAccountByIdStore, statusByUserStore } from '@digitranslab/contact-resources'
  import { Doc, reduceCalls, Ref } from '@digitranslab/core'
  import { DocNotifyContext } from '@digitranslab/notification'
  import { getResource, IntlString, translate } from '@digitranslab/platform'
  import { getClient } from '@digitranslab/presentation'
  import ui, { Action, AnySvelteComponent, IconSize, ModernButton, NavGroup } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import { getDocTitle } from '@digitranslab/view-resources'
