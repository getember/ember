...
-->
<script lang="ts">
  import core, { Account, Class, getCurrentAccount, Ref } from '@digitranslab/core'
  import presentation from '@digitranslab/presentation'
  import { Label, showPopup, tooltip } from '@digitranslab/ui'

  import { Channel, ChunterSpace, ObjectChatPanel } from '@digitranslab/chunter'
  import { Person, PersonAccount } from '@digitranslab/contact'
  import { EmployeeBox, personAccountByIdStore, SelectUsersPopup } from '@digitranslab/contact-resources'
