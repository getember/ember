...
-->
<script lang="ts">
  import { Doc, Ref, Class } from '@digitranslab/core'
  ...
  import { NavigatorModel, SpecialNavModel } from '@digitranslab/workbench'
  ...
  import { parseLinkId, getObjectLinkId } from '@digitranslab/view-resources'
