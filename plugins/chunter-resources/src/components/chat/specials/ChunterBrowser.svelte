...
<script lang="ts">
  ...
  import { FileBrowser } from '@digitranslab/attachment-resources'
  import { Scroller, Switcher } from '@digitranslab/ui'
  import type { AnySvelteComponent } from '@digitranslab/ui'
  import workbench from '@digitranslab/workbench'
  import contact from '@digitranslab/contact'
  import contactPlg from '@digitranslab/contact-resources/src/plugin'
  import { EmployeeBrowser } from '@digitranslab/contact-resources'
  import MessagesBrowser from './MessagesBrowser.svelte'
  import { FilterBar, FilterButton } from '@digitranslab/view-resources'
