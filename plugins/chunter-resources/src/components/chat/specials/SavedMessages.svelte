...
-->
<script lang="ts">
  import { Attachment, SavedAttachments } from '@digitranslab/attachment'
  import { AttachmentPreview } from '@digitranslab/attachment-resources'
  import { Person, PersonAccount, getName as getContactName } from '@digitranslab/contact'
  import { personAccountByIdStore, personByIdStore } from '@digitranslab/contact-resources'
  import { getDisplayTime, IdMap, Ref, WithLookup } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Label, Scroller } from '@digitranslab/ui'
  import activity, { ActivityMessage, SavedMessage } from '@digitranslab/activity'
  import { ActivityMessagePresenter, savedMessagesStore } from '@digitranslab/activity-resources'
