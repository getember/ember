...
import { type Ref, type Doc, type Class, generateId } from '@digitranslab/core'
import activity, { type ActivityMessage } from '@digitranslab/activity'
import {
  type Channel,
  type ChatWidgetTab,
  chunterId,
  type ChunterSpace,
  type ThreadMessage
} from '@digitranslab/chunter'
import { type DocNotifyContext, notificationId } from '@digitranslab/notification'
import workbench, { type Widget, workbenchId, type LocationData } from '@digitranslab/workbench'
import { classIcon, getObjectLinkId, parseLinkId } from '@digitranslab/view-resources'
import { getClient } from '@digitranslab/presentation'
import view, { encodeObjectURI, decodeObjectURI } from '@digitranslab/view'
import { createWidgetTab, isElementFromSidebar, sidebarStore } from '@digitranslab/workbench-resources'
import { type Asset, type IntlString, translate } from '@digitranslab/platform'
