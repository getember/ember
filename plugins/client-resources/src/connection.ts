...
import client, { ClientSocket, ClientSocketReadyState, type ClientFactoryOptions } from '@digitranslab/client'
import core, {
  Account,
  Class,
  ClientConnectEvent,
...
import { HelloRequest, HelloResponse, RPCHandler, ReqId, type Response } from '@digitranslab/rpc'
