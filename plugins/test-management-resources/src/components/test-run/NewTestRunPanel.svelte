...
<script lang="ts">
  ...
  import { ActionContext, createMarkup, createQuery, getClient } from '@digitranslab/presentation'
  import core, { Data, Ref, getCurrentAccount, generateId, makeCollabId, WithLookup } from '@digitranslab/core'
  import testManagement, {
    ...
    TestPlan,
    TestPlanItem
  } from '@digitranslab/test-management'
  import { Panel } from '@digitranslab/panel'
  import { EditBox, ModernButton, Label, navigate } from '@digitranslab/ui'
