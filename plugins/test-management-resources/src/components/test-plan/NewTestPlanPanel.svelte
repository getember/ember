...
<script lang="ts">
  ...
  import { ActionContext, getClient } from '@digitranslab/presentation'
  import core, { Data, Ref, generateId, getCurrentAccount } from '@digitranslab/core'
  ...
  import { ModernButton, EditBox, Label } from '@digitranslab/ui'
