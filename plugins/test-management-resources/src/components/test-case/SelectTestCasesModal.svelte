...
<script lang="ts">
  ...
  import { TestCase, TestProject } from '@digitranslab/test-management'
  import { Button, Dialog, Label } from '@digitranslab/ui'
  import { ComponentNavigator } from '@digitranslab/workbench-resources'
  import view from '@digitranslab/view'
  import { selectionStore } from '@digitranslab/view-resources'
