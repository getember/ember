...
<script lang="ts">
  ...
  import { AttachmentPresenter, AttachmentStyledBox } from '@digitranslab/attachment-resources'
  import { TestCase, TestProject, TestSuite, TestCaseStatus } from '@digitranslab/test-management'
  import core, { fillDefaults, generateId, makeCollabId, Ref, TxOperations, Data } from '@digitranslab/core'
  import { ObjectBox } from '@digitranslab/view-resources'
  import { Card, SpaceSelector, createMarkup, getClient } from '@digitranslab/presentation'
  import { EmptyMarkup, isEmptyMarkup } from '@digitranslab/text'
  import { Button, createFocusManager, EditBox, FocusHandler, IconAttachment, getLocation } from '@digitranslab/ui'
