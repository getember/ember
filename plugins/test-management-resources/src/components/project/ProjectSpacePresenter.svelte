...
<script lang="ts">
  ...
  import { NavLink, TreeNode } from '@digitranslab/view-resources'
  import { SpacesNavModel, SpecialNavModel } from '@digitranslab/workbench'
  import { SpecialElement } from '@digitranslab/workbench-resources'
