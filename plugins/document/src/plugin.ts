...
import type { Class, Doc, Mixin, Ref, SpaceType, SpaceTypeDescriptor } from '@digitranslab/core'
import { NotificationGroup, NotificationType } from '@digitranslab/notification'
import type { Asset, Plugin, Resource } from '@digitranslab/platform'
import { IntlString, plugin } from '@digitranslab/platform'
import type { AnyComponent, Location, ResolvedLocation } from '@digitranslab/ui'
