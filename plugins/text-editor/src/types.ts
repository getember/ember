...
import { type Class, type Space, type Account, type Doc, type Markup, type Ref } from '@digitranslab/core'
import type { AnySvelteComponent } from '@digitranslab/ui/src/types'
