...
import products, { type Product } from '@digitranslab/products'
import type { Class, Client, DocumentQuery, Ref, RelatedDocument, WithLookup } from '@digitranslab/core'
import { type Resources } from '@digitranslab/platform'
import { type ObjectSearchResult } from '@digitranslab/presentation'
