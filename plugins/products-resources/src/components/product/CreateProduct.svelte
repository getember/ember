...
<script lang="ts">
  ...
  import { type DocumentSpaceType } from '@digitranslab/controlled-documents'
  import { type Product, ProductVersionState } from '@digitranslab/products'
  ...
  import { AccountArrayEditor } from '@digitranslab/contact-resources'
  import core, {
    Account,
    Data,
    Ref,
  ...
  import { Card, MessageBox, createQuery, getClient } from '@digitranslab/presentation'
  import {
    Button,
    DropdownLabelsIntl,
    EditBox,
  ...
  import { IconPicker, SpaceTypeSelector } from '@digitranslab/view-resources'
