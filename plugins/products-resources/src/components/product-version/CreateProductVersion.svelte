...
<script lang="ts">
  ...
  import { Product, ProductVersion, ProductVersionState } from '@digitranslab/products'
  import { Data, Ref, SortingOrder, generateId } from '@digitranslab/core'
  import { Card, MessageBox, SpaceSelector, createQuery, getClient } from '@digitranslab/presentation'
  import { StyledTextBox } from '@digitranslab/text-editor-resources'
  import { DropdownLabelsIntl, EditBox, FocusHandler, createFocusManager, showPopup } from '@digitranslab/ui'
