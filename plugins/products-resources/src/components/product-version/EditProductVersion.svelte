...
<script lang="ts">
  ...
  import core, { Class, Doc, Ref, WithLookup, getCurrentAccount } from '@digitranslab/core'
  ...
  import { ActionContext, MessageViewer, createQuery, getClient } from '@digitranslab/presentation'
  import { Button, IconMixin, IconMoreH } from '@digitranslab/ui'
  import {
    DocAttributeBar,
    checkMyPermission,
    getDocMixins,
  ...
  import type { ProductVersion } from '@digitranslab/products'
