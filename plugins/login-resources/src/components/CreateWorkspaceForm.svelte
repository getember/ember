...
-->
<script lang="ts">
  import { OK, Severity, Status, getEmbeddedLabel } from '@digitranslab/platform'

  import { LoginInfo } from '@digitranslab/login'
  import { ButtonMenu, DropdownLabels, getCurrentLocation, navigate } from '@digitranslab/ui'
