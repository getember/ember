...
<script lang="ts">
  ...
  import { AnyComponent, AnySvelteComponent, ExpandCollapse, mouseAttractor } from '@digitranslab/ui'
  import { AttributeModel, BuildModelKey, ViewOptionModel, ViewOptions, Viewlet } from '@digitranslab/view'
