...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Ref, Space } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { ActionContext } from '@digitranslab/presentation'
  import { AnyComponent, Scroller, resizeObserver } from '@digitranslab/ui'
  import { BuildModelKey, ViewOptions, Viewlet } from '@digitranslab/view'
