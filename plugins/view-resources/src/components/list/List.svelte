...
<script lang="ts">
  ...
  import { createQuery, getClient, reduceCalls } from '@digitranslab/presentation'
  import { AnyComponent, AnySvelteComponent } from '@digitranslab/ui'
  import { BuildModelKey, ViewOptionModel, ViewOptions, ViewQueryOption, Viewlet } from '@digitranslab/view'
