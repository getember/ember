...
-->
<script lang="ts">
  import { AnyAttribute, Doc, getObjectValue } from '@digitranslab/core'
  import notification from '@digitranslab/notification'
  import { getClient, updateAttribute } from '@digitranslab/presentation'
  import { CheckBox, Component, IconCircles, tooltip, deviceOptionsStore as deviceInfo } from '@digitranslab/ui'
