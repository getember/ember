...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, FindResult, Ref, SortingOrder } from '@digitranslab/core'
  import { Asset, getResource, IntlString } from '@digitranslab/platform'
  import presentation, { createQuery, getClient } from '@digitranslab/presentation'
  import { DocWithRank, makeRank } from '@digitranslab/task'
  import { Button, Component, Icon, IconAdd, IconSize, Label, Loading } from '@digitranslab/ui'
  import view, { ObjectFactory } from '@digitranslab/view'
