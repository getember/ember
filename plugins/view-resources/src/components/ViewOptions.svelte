<script lang="ts">
  ...
  import { DropdownIntlItem, DropdownLabelsIntl, Label, Toggle } from '@digitranslab/ui'
  import { Viewlet, ViewOptions, ViewOptionsModel, ViewOptionModel } from '@digitranslab/view'
