...
<script lang="ts">
  ...
  import type { AnySvelteComponent, ButtonKind, ButtonSize, IconProps } from '@digitranslab/ui'
  import { Button, Label, eventToHTMLElement, parseURL, showPopup } from '@digitranslab/ui'
