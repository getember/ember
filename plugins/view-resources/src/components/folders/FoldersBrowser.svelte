...
<script lang="ts">
  ...
  import { Class, Doc, DocumentQuery, Ref, SortingOrder } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Action, IconEdit, navigate, type Location, Scroller, location, getLocation } from '@digitranslab/ui'
  import { getResource, type Resource } from '@digitranslab/platform'
