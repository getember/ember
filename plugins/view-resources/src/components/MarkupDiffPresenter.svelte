...
-->
<script lang="ts">
  import { AnyAttribute, Markup } from '@digitranslab/core'
  import { EmptyMarkup, MarkupNode, MarkupNodeType, markupToJSON } from '@digitranslab/text'
  import { MarkupDiffViewer } from '@digitranslab/text-editor-resources'
  import { ShowMore } from '@digitranslab/ui'
