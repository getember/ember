...
<script lang="ts">
  ...
  import { type Class, type Doc, type DocumentQuery, type FindOptions, type Ref } from '@digitranslab/core'
  import type { IntlString } from '@digitranslab/platform'
  import presentation, { ObjectCreate, ObjectPopup } from '@digitranslab/presentation'
