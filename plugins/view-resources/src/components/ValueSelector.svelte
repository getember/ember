<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Hierarchy, Mixin, Ref, generateId } from '@digitranslab/core'
  import { Asset, IntlString } from '@digitranslab/platform'
  import { ObjectPopup, getClient, updateAttribute } from '@digitranslab/presentation'
  import { Label, SelectPopup, resizeObserver } from '@digitranslab/ui'
