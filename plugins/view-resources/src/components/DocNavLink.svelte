...
-->
<script lang="ts">
  import { Doc, Hierarchy } from '@digitranslab/core'
  import { NavLink, getClient } from '@digitranslab/presentation'
  import { AnyComponent, getPanelURI, locationToUrl } from '@digitranslab/ui'
