...
-->
<script lang="ts">
  import core, { Class, Doc, Ref } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { AttributesBar, KeyedAttribute, getAttribute, getClient } from '@digitranslab/presentation'
  import setting, { settingId } from '@digitranslab/setting'
  import { Button, Label, getCurrentResolvedLocation, navigate } from '@digitranslab/ui'
