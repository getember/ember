...
-->
<script lang="ts">
  import core, { AnyAttribute, Class, Doc, Ref, Type } from '@digitranslab/core'
  import { Asset, IntlString } from '@digitranslab/platform'
  import { createQuery, getAttributePresenterClass, getClient, hasResource } from '@digitranslab/presentation'
  import { Loading, resizeObserver } from '@digitranslab/ui'
  import DropdownLabelsIntl from '@digitranslab/ui/src/components/DropdownLabelsIntl.svelte'
  import { BuildModelKey, Viewlet, ViewletPreference } from '@digitranslab/view'
