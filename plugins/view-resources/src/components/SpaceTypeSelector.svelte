...
<script lang="ts">
  ...
  import core, { type Ref, type SpaceType, type SpaceTypeDescriptor } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import { type DropdownTextItem, ButtonKind, ButtonSize, DropdownLabels } from '@digitranslab/ui'
