...
<script lang="ts">
  ...
  import core, { Doc, Hierarchy, Ref, Space, TxRemoveDoc } from '@digitranslab/core'
  import { getResource } from '@digitranslab/platform'
  import { addTxListener, contextStore, getClient, reduceCalls } from '@digitranslab/presentation'
  import { AnyComponent, Component } from '@digitranslab/ui'
  import { Action, ViewContextType } from '@digitranslab/view'
