...
<script lang="ts">
  ...
  import { getResource, translate, translateCB } from '@digitranslab/platform'
  import {
    ActionContext,
    SearchResult,
    addTxListener,
  ...
  import { Action, ActionCategory, ViewContext } from '@digitranslab/view'
  ...
  import { contextStore } from '@digitranslab/presentation'
