...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, Ref, Space, getCurrentAccount } from '@digitranslab/core'
  import { getResource } from '@digitranslab/platform'
  import { getClient, reduceCalls } from '@digitranslab/presentation'
  import { Button, IconAdd, eventToHTMLElement, getCurrentLocation, showPopup } from '@digitranslab/ui'
  import { Filter, FilteredView, ViewOptions, Viewlet } from '@digitranslab/view'
