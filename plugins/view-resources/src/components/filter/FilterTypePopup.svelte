...
-->
<script lang="ts">
  import core, { AnyAttribute, ArrOf, Class, Doc, Ref, RefTo, Space, Type } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Label, Scroller, Submenu, closePopup, closeTooltip, resizeObserver, showPopup } from '@digitranslab/ui'
  import { ClassFilters, Filter, KeyFilter, KeyFilterPreset, ViewOptions } from '@digitranslab/view'
