...
-->
<script lang="ts">
  import core, { Class, Doc, Ref, RefTo, Space, Status } from '@digitranslab/core'
  import { translate } from '@digitranslab/platform'
  import { getAttributePresenterClass, getClient } from '@digitranslab/presentation'
  import {
    AnyComponent,
    Component,
    eventToHTMLElement,
  ...
  import { Filter, FilterMode } from '@digitranslab/view'
