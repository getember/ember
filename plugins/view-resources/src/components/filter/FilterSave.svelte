<script lang="ts">
  import core, { Class, Doc, Ref, getCurrentAccount } from '@digitranslab/core'
  import { Card, getClient } from '@digitranslab/presentation'
  import { Button, EditBox, ToggleWithLabel, getCurrentResolvedLocation } from '@digitranslab/ui'
  import { ViewOptions } from '@digitranslab/view'
