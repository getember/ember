...
-->
<script lang="ts">
  import { getClient, SpaceSelect } from '@digitranslab/presentation'
  import { Button, Label, Status as StatusControl, themeStore } from '@digitranslab/ui'

  import core, { Class, Client, Doc, Ref, SortingOrder, Space } from '@digitranslab/core'
  import { OK, Resource, Status, getResource, translate } from '@digitranslab/platform'
  import task, { Project, Task, makeRank } from '@digitranslab/task'
