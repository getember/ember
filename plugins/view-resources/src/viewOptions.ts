import { type Class, type Doc, type DocumentQuery, type Ref, SortingOrder, type Space } from '@digitranslab/core'
import { getResource } from '@digitranslab/platform'
import { type LiveQuery, createQuery, getAttributePresenterClass, getClient } from '@digitranslab/presentation'
import { locationToUrl, getCurrentResolvedLocation } from '@digitranslab/ui'
import {
