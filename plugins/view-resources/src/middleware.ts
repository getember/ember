...
import { BasePresentationMiddleware, type PresentationMiddleware } from '@digitranslab/presentation'
import view, { type IAggregationManager } from '@digitranslab/view'
