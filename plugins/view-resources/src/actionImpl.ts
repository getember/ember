...
import { type Asset, type IntlString, type Resource, getResource } from '@digitranslab/platform'
import { MessageBox, getClient, updateAttribute, type ContextStore, contextStore } from '@digitranslab/presentation'
import {
  type AnyComponent,
...
import { locationToUrl } from '@digitranslab/ui'
