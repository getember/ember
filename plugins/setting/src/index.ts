...
import type { Account, AccountRole, Blob, Class, Configuration, Doc, Mixin, Ref } from '@digitranslab/core'
import type { Plugin } from '@digitranslab/platform'
import { Asset, IntlString, Resource, plugin } from '@digitranslab/platform'
