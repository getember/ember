...
-->
<script lang="ts">
  import { AvatarType, Channel, combineName, Contact, findContacts, type Organization } from '@digitranslab/contact'
  import { ChannelsDropdown, EditableAvatar, PersonPresenter } from '@digitranslab/contact-resources'
  import contact from '@digitranslab/contact-resources/src/plugin'
  import {
    AttachedData,
    Class,
    Data,
  ...
  import { Customer, LeadEvents } from '@digitranslab/lead'
  import { Card, createMarkup, getClient, InlineAttributeBar } from '@digitranslab/presentation'
