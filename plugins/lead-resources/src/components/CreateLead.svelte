...
-->
<script lang="ts">
  import contact, { Contact } from '@digitranslab/contact'
  import { UserBox } from '@digitranslab/contact-resources'
  import {
    AccountRole,
    AttachedData,
    AttachedDoc,
  ...
  import { Customer, Funnel, Lead, LeadEvents } from '@digitranslab/lead'
  import { OK, Status } from '@digitranslab/platform'
  import { Card, createQuery, getClient, InlineAttributeBar, SpaceSelector } from '@digitranslab/presentation'
  import task, { getStates, makeRank, TaskType } from '@digitranslab/task'
  import { TaskKindSelector, typeStore } from '@digitranslab/task-resources'
  import { Button, createFocusManager, EditBox, FocusHandler, Label, Status as StatusControl } from '@digitranslab/ui'
