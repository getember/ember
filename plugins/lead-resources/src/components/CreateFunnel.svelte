...
<script lang="ts">
  ...
  import lead, { Funnel, LeadEvents } from '@digitranslab/lead'
  import presentation, { getClient, SpaceCreateCard } from '@digitranslab/presentation'
  import task, { ProjectType } from '@digitranslab/task'
  import ui, { Component, EditBox, Label, Toggle, ToggleWithLabel } from '@digitranslab/ui'
