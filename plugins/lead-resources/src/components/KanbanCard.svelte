...
<script lang="ts">
  ...
  import { ContactPresenter } from '@digitranslab/contact-resources'
  import type { WithLookup } from '@digitranslab/core'
  import type { Lead } from '@digitranslab/lead'
  ...
  import { AssigneePresenter, StateRefPresenter } from '@digitranslab/task-resources'
  import { ActionIcon, Component, DueDatePresenter, IconMoreH } from '@digitranslab/ui'
  import { BuildModelKey } from '@digitranslab/view'
  import { enabledConfig, openDoc, showMenu, statusStore } from '@digitranslab/view-resources'
