...
import type { Answer, AnswerDataOf, Question } from '@digitranslab/questions'
import { type AttachedData, type Class, type Doc, type Ref, type Space, type TxOperations } from '@digitranslab/core'
