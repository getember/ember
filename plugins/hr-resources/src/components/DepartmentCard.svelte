...
<script lang="ts">
  ...
  import { Avatar, EmployeePresenter, UsersPopup } from '@digitranslab/contact-resources'
  ...
  import { Button, IconAdd, Label, closeTooltip, eventToHTMLElement, showPopup } from '@digitranslab/ui'
  import { openDoc, showMenu } from '@digitranslab/view-resources'
