...
<script lang="ts">
  ...
  import { EmployeeBox } from '@digitranslab/contact-resources'
  import core, { DocumentQuery, generateId, Markup, Ref } from '@digitranslab/core'
  import { Request, RequestType, Staff, timeToTzDate } from '@digitranslab/hr'
  import { translate } from '@digitranslab/platform'
  import { Card, createQuery, getClient } from '@digitranslab/presentation'
