...
<script lang="ts">
  ...
  import { DocumentQuery, Ref, WithLookup } from '@digitranslab/core'
  import type { Department, Staff } from '@digitranslab/hr'
  import { createQuery } from '@digitranslab/presentation'
  import { Button, IconAdd, Label, Scroller, SearchEdit, eventToHTMLElement, showPopup } from '@digitranslab/ui'
