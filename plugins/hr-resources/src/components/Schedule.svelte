...
<script lang="ts">
  ...
  import view, { Viewlet, ViewletPreference } from '@digitranslab/view'
  import { ViewletSelector, ViewletSettingButton } from '@digitranslab/view-resources'
...
<div class="emberPanels-container">
  ...
  <div class="emberComponent" bind:this={replacedPanel}>
    <Header
      adaptive={'disabled'}
    ...
    <div class="emberHeader-container clearPadding justify-between flex-gap-4">
      <div class="flex-row-center flex-gap-2">
        ...
        />
        <div class="emberHeader-divider short" />
