...
<script lang="ts">
  ...
  import { UsersPopup } from '@digitranslab/contact-resources'
  ...
  import { Button, IconAdd, Label, Scroller, Section, eventToHTMLElement, showPopup } from '@digitranslab/ui'
  import { Viewlet, ViewletPreference } from '@digitranslab/view'
  import { Table, ViewletSelector, ViewletSettingButton } from '@digitranslab/view-resources'
