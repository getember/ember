...
-->
<script lang="ts">
  import hr, { Request, RequestType } from '@digitranslab/hr'
  import { getClient } from '@digitranslab/presentation'
  import { jsonToText, markupToJSON } from '@digitranslab/text'
  import { Icon, Label, closeTooltip } from '@digitranslab/ui'
