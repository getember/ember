...
<script lang="ts">
  ...
  import type { Request, RequestType, Staff } from '@digitranslab/hr'
  import { Department } from '@digitranslab/hr'
  import { getEmbeddedLabel } from '@digitranslab/platform'
  import { Button, DropdownIntlItem, Label, Loading, showPopup, tableToCSV } from '@digitranslab/ui'
  import { BuildModelKey, Viewlet, ViewletPreference } from '@digitranslab/view'
  import { TableBrowser, ViewletSelector, ViewletSettingButton } from '@digitranslab/view-resources'
