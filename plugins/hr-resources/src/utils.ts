import { type Employee, getName } from '@digitranslab/contact'
import { type Ref, type TxOperations } from '@digitranslab/core'
import { type Department, type Request, type RequestType, type Staff, fromTzDate } from '@digitranslab/hr'
import { MessageBox } from '@digitranslab/presentation'
import { type Issue, type TimeSpendReport } from '@digitranslab/tracker'
import { MILLISECONDS_IN_DAY, areDatesEqual, isWeekend, showPopup } from '@digitranslab/ui'
