import type { ActivityMessage, Reaction } from '@digitranslab/activity'
import core, { getCurrentAccount, isOtherHour, type Doc, type Ref, type Space } from '@digitranslab/core'
...
import { type AttributeModel } from '@digitranslab/view'
