...
<script lang="ts">
  import { ComponentExtensions, getClient, LiteMessageViewer } from '@digitranslab/presentation'
  import { Person, type PersonAccount } from '@digitranslab/contact'
  import { Avatar, personAccountByIdStore, personByIdStore, SystemAvatar } from '@digitranslab/contact-resources'
  import core, { Account, Doc, Ref, Timestamp, type WithLookup } from '@digitranslab/core'
  import { Icon, Label, resizeObserver, TimeSince, tooltip } from '@digitranslab/ui'
  import { Asset, getEmbeddedLabel, IntlString } from '@digitranslab/platform'
  import activity, { ActivityMessage, ActivityMessagePreviewType } from '@digitranslab/activity'
  import { classIcon, DocNavLink } from '@digitranslab/view-resources'
  import { markupToText } from '@digitranslab/text'
