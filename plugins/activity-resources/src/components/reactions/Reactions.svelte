...
<script lang="ts">
  ...
  import { Reaction } from '@digitranslab/activity'
  import { Account, Doc, getCurrentAccount, Ref } from '@digitranslab/core'
  import { EmojiPopup, IconAdd, showPopup, tooltip } from '@digitranslab/ui'
