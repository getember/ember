...
<script lang="ts">
  ...
  import { Avatar, SystemAvatar } from '@digitranslab/contact-resources'
  import core, { Ref } from '@digitranslab/core'
  import { ComponentExtensions, getClient } from '@digitranslab/presentation'
  import { Action, Icon, Label } from '@digitranslab/ui'
  import { getActions, restrictionStore, showMenu } from '@digitranslab/view-resources'
  import { Asset } from '@digitranslab/platform'
  import { Action as ViewAction } from '@digitranslab/view'
