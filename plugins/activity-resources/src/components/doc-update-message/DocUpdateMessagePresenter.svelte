...
<script lang="ts">
  ...
  import { Account, AttachedDoc, Class, Collection, Doc, Ref, Space } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Action, Component, ShowMore } from '@digitranslab/ui'
  import { AttributeModel } from '@digitranslab/view'
  import { buildRemovedDoc, checkIsObjectRemoved } from '@digitranslab/view-resources'
