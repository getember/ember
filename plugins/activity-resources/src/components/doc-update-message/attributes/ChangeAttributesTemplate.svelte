...
-->
<script lang="ts">
  import { Icon, IconEdit, Component } from '@digitranslab/ui'
  import { ObjectPresenter } from '@digitranslab/view-resources'
  import { getClient } from '@digitranslab/presentation'
  import { Doc, Ref, Space } from '@digitranslab/core'
  import { AttributeModel } from '@digitranslab/view'
  import { DocAttributeUpdates, DocUpdateMessageViewlet } from '@digitranslab/activity'
