...
-->
<script lang="ts">
  import { DisplayDocUpdateMessage, DocUpdateMessageViewlet } from '@digitranslab/activity'
  import { Class, Doc, Ref } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { AnyComponent, Component, Icon, IconAdd, IconDelete } from '@digitranslab/ui'
