...
<script lang="ts">
  ...
  import { Data, generateId, Ref } from '@digitranslab/core'
  import { Document, DocumentEvents, Teamspace } from '@digitranslab/document'
  ...
  import { IconPicker, ObjectBox } from '@digitranslab/view-resources'
