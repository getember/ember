...
<script lang="ts">
  ...
  import { Action, IconAdd, IconEdit, IconWithEmoji, getPlatformColorDef, themeStore } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import { getActions as getContributedActions, openDoc } from '@digitranslab/view-resources'
