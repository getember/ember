...
<script lang="ts">
  ...
  import { Ref, SortingOrder, Space, generateId } from '@digitranslab/core'
  ...
  import { TreeNode, openDoc, getActions as getContributedActions } from '@digitranslab/view-resources'
  import { SpacesNavModel } from '@digitranslab/workbench'
