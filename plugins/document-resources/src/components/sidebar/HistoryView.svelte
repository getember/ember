...
<script lang="ts">
  ...
  import { EmployeePresenter, employeeByIdStore, personAccountByIdStore } from '@digitranslab/contact-resources'
  import { Ref } from '@digitranslab/core'
  import { DocumentSnapshot } from '@digitranslab/document'
  import { TimeSince } from '@digitranslab/ui'
