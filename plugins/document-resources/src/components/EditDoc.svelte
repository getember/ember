...
-->
<script lang="ts">
  import attachment, { Attachment } from '@digitranslab/attachment'
  import core, { Doc, Ref, WithLookup, generateId, type Blob } from '@digitranslab/core'
  import { Document, DocumentEvents } from '@digitranslab/document'
  ...
  import { copyTextToClipboard, createQuery, getClient } from '@digitranslab/presentation'
  import tags from '@digitranslab/tags'
  import { Heading } from '@digitranslab/text-editor'
  import { TableOfContents } from '@digitranslab/text-editor-resources'
  import {
    Button,
    ButtonItem,
    Component,
