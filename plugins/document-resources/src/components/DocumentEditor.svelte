...
<script lang="ts">
  ...
  import document, { Document } from '@digitranslab/document'
  import { getResource } from '@digitranslab/platform'
  import { getClient } from '@digitranslab/presentation'
  import { CollaboratorEditor, HeadingsExtension, ImageUploadOptions } from '@digitranslab/text-editor-resources'
  import { AnySvelteComponent } from '@digitranslab/ui'
