...
<script lang="ts">
  ...
  import { Label, Loading, SearchEdit } from '@digitranslab/ui'
  import view, { Viewlet, ViewletPreference } from '@digitranslab/view'
  import { FilterButton, TableBrowser, ViewletSelector, ViewletSettingButton } from '@digitranslab/view-resources'
