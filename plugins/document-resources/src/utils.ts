...
import { type Document, type Teamspace, documentId, getFirstRank } from '@digitranslab/document'
import { getMetadata, translate } from '@digitranslab/platform'
import presentation, { getClient } from '@digitranslab/presentation'
import { makeRank } from '@digitranslab/rank'
import { type Location, type ResolvedLocation, getCurrentResolvedLocation, getPanelURI } from '@digitranslab/ui'
import { accessDeniedStore } from '@digitranslab/view-resources'
