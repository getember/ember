...
import { type Resources, type Status, translate } from '@digitranslab/platform'
import { getClient, MessageBox, type ObjectSearchResult } from '@digitranslab/presentation'
import { type Component, type Issue, type Milestone, type Project } from '@digitranslab/tracker'
import { closePanel, getCurrentLocation, navigate, showPopup, themeStore } from '@digitranslab/ui'
...
import { AggregationManager, deleteObject, deleteObjects } from '@digitranslab/view-resources'
...
import contact, { AvatarType } from '@digitranslab/contact'
import { personAccountByIdStore, personAccountPersonByIdStore, personByIdStore } from '@digitranslab/contact-resources'
import notification, { type Collaborators } from '@digitranslab/notification'
import { settingId } from '@digitranslab/setting'
import task, { type TaskType } from '@digitranslab/task'
import { getAllStates } from '@digitranslab/task-resources'
