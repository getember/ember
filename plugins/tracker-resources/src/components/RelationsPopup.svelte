<script lang="ts">
  import { Class, Doc, Ref, RelatedDocument } from '@digitranslab/core'
  import { getResource, IntlString } from '@digitranslab/platform'
  import { createQuery, getClient, ObjectSearchPopup, ObjectSearchResult } from '@digitranslab/presentation'
  import { Issue } from '@digitranslab/tracker'
  import { Action, closePopup, Menu, showPopup } from '@digitranslab/ui'
