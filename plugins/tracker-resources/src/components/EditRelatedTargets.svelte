<script lang="ts">
  import core, { Space, WithLookup } from '@digitranslab/core'
  import { SpaceSelector, createQuery, getClient } from '@digitranslab/presentation'
  import { RelatedIssueTarget } from '@digitranslab/tracker'
  import { Button, Icon, IconArrowRight, IconDelete, Label } from '@digitranslab/ui'
