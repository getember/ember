...
<script lang="ts">
  ...
  import { AccountArrayEditor, AssigneeBox } from '@digitranslab/contact-resources'
  import core, {
    Account,
    Data,
    DocumentUpdate,
  ...
  import presentation, { Card, createQuery, getClient } from '@digitranslab/presentation'
  import task, { ProjectType, TaskType } from '@digitranslab/task'
  import { taskTypeStore, typeStore } from '@digitranslab/task-resources'
  import { IssueStatus, Project, TimeReportDayType, TrackerEvents } from '@digitranslab/tracker'
  import {
    Button,
    Component,
    EditBox,
  ...
  import { IconPicker } from '@digitranslab/view-resources'
