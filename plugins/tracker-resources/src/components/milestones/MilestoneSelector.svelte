...
-->
<script lang="ts">
  import { DocumentQuery, Ref, SortingOrder } from '@digitranslab/core'
  import { IntlString, getEmbeddedLabel, translateCB } from '@digitranslab/platform'
  import { createQuery } from '@digitranslab/presentation'
  import { Milestone } from '@digitranslab/tracker'
  import type { ButtonKind, ButtonSize, LabelAndProps, PopupResult } from '@digitranslab/ui'
  import { Button, ButtonShape, Label, SelectPopup, eventToHTMLElement, showPopup, themeStore } from '@digitranslab/ui'
