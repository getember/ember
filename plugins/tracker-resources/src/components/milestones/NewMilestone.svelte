...
-->
<script lang="ts">
  import { Data, Ref } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { Card, getClient, SpaceSelector } from '@digitranslab/presentation'
  import { Milestone, MilestoneStatus, Project } from '@digitranslab/tracker'
  import ui, { DatePresenter, EditBox } from '@digitranslab/ui'
