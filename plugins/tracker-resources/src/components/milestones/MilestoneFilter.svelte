...
-->
<script lang="ts">
  import { DocumentQuery, FindResult, Ref, SortingOrder } from '@digitranslab/core'
  import presentation, { getClient } from '@digitranslab/presentation'
  import { Project, Milestone, MilestoneStatus } from '@digitranslab/tracker'
  import ui, {
    IconCheck,
    Icon,
    Label,
  ...
  import { FILTER_DEBOUNCE_MS, sortFilterValues } from '@digitranslab/view-resources'
  import view, { Filter } from '@digitranslab/view'
