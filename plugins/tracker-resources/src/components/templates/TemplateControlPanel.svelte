...
-->
<script lang="ts">
  import { generateId, Ref, WithLookup } from '@digitranslab/core'
  import { AttributeBarEditor, getClient, KeyedAttribute } from '@digitranslab/presentation'
  import tags, { TagElement, TagReference } from '@digitranslab/tags'
  import type { IssueTemplate } from '@digitranslab/tracker'
  import { Component, Label } from '@digitranslab/ui'
  import { getFiltredKeys, isCollectionAttr } from '@digitranslab/view-resources'
