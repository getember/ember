...
<script lang="ts">
  ...
  import core, { Account, Doc, generateId, Ref } from '@digitranslab/core'
  import presentation, { DraftController, getClient, KeyedAttribute } from '@digitranslab/presentation'
  import tags, { TagElement, TagReference } from '@digitranslab/tags'
  import { TaskType } from '@digitranslab/task'
  ...
  import { Button, Component, EditBox } from '@digitranslab/ui'
