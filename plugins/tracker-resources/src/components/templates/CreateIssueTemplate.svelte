...
<script lang="ts">
  ...
  import { Data, Doc, Ref, generateId } from '@digitranslab/core'
  import { Card, KeyedAttribute, SpaceSelector, getClient } from '@digitranslab/presentation'
  import tags, { TagElement } from '@digitranslab/tags'
  import { StyledTextBox } from '@digitranslab/text-editor-resources'
  import { Component as ComponentType, IssuePriority, IssueTemplate, Milestone, Project } from '@digitranslab/tracker'
  import { Component, EditBox, Label } from '@digitranslab/ui'
