...
-->
<script lang="ts">
  import { AttachmentStyleBoxEditor } from '@digitranslab/attachment-resources'
  import { Class, Doc, Ref, WithLookup } from '@digitranslab/core'
  ...
  import setting, { settingId } from '@digitranslab/setting'
  import tags from '@digitranslab/tags'
  import { IssueTemplate, IssueTemplateChild, Project } from '@digitranslab/tracker'
  import { Button, EditBox, IconMoreH, Label, getCurrentResolvedLocation, navigate } from '@digitranslab/ui'
