<script lang="ts">
  ...
  import { IssueTemplate } from '@digitranslab/tracker'
  import { Button, IconAdd, showPopup, themeStore } from '@digitranslab/ui'
  import { ViewOptions, Viewlet } from '@digitranslab/view'
  import { FilterBar, SpaceHeader, ViewletSettingButton } from '@digitranslab/view-resources'
