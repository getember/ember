...
-->
<script lang="ts">
  import { Data } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { IssueDraft, IssueTemplate, IssueTemplateChild, TrackerEvents } from '@digitranslab/tracker'
  import { Button, ButtonKind, ButtonSize, eventToHTMLElement, showPopup } from '@digitranslab/ui'
  import { EditBoxPopup, getObjectId } from '@digitranslab/view-resources'
