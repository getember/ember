...
<script lang="ts">
  ...
  import tracker, { Component, Issue, IssueTemplateChild, Milestone, Project } from '@digitranslab/tracker'
  import { IconCircles, eventToHTMLElement, showPopup } from '@digitranslab/ui'
  import { FixedColumn } from '@digitranslab/view-resources'
