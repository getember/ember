...
<script lang="ts">
  ...
  import { getResource, translate } from '@digitranslab/platform'
  import preference, { SpacePreference } from '@digitranslab/preference'
  import {
    Card,
  ...
  import tags, { TagElement, TagReference } from '@digitranslab/tags'
  import { TaskType, makeRank } from '@digitranslab/task'
  import { TaskKindSelector } from '@digitranslab/task-resources'
