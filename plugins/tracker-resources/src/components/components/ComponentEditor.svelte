...
-->
<script lang="ts">
  import { AttachedData, DocumentQuery, Ref } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { RuleApplyResult, getClient, getDocRules } from '@digitranslab/presentation'
  import { Component, Issue, IssueTemplate, Project, TrackerEvents } from '@digitranslab/tracker'
  import { ButtonKind, ButtonShape, ButtonSize, deviceOptionsStore as deviceInfo } from '@digitranslab/ui'
