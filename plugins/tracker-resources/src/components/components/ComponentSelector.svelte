...
<script lang="ts">
  ...
  import type { ButtonKind, ButtonSize, LabelAndProps, SelectPopupValueType } from '@digitranslab/ui'
  import { Button, ButtonShape, SelectPopup, eventToHTMLElement, showPopup, PopupResult } from '@digitranslab/ui'
