...
-->
<script lang="ts">
  import { DocumentQuery, WithLookup } from '@digitranslab/core'
  import type { IntlString } from '@digitranslab/platform'
  import { isCreateAllowed } from '@digitranslab/presentation'
  import { Component } from '@digitranslab/tracker'
  import { Button, IconAdd, Breadcrumbs, SearchInput, showPopup, Header } from '@digitranslab/ui'
