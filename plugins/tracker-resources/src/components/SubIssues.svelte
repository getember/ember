...
<script lang="ts">
  ...
  import core, { AttachedData, Doc, makeCollabId, Ref, SortingOrder } from '@digitranslab/core'
  import { DraftController, draftsStore, getClient, deleteFile, createMarkup } from '@digitranslab/presentation'
  import tags from '@digitranslab/tags'
  import { makeRank } from '@digitranslab/task'
  import { isEmptyMarkup } from '@digitranslab/text'
  import { Component, Issue, IssueDraft, IssueParentInfo, Milestone, Project } from '@digitranslab/tracker'
  import { Button, ExpandCollapse, Scroller } from '@digitranslab/ui'
