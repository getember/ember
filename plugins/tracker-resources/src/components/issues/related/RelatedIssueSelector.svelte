...
-->
<script lang="ts">
  import { Doc, Ref, WithLookup, type Status } from '@digitranslab/core'
  import task from '@digitranslab/task'
  import { Project, type Issue } from '@digitranslab/tracker'
  import { Button, ButtonKind, ButtonSize, ProgressCircle } from '@digitranslab/ui'
