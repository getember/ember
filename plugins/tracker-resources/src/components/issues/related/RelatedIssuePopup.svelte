...
-->
<script lang="ts">
  import core, { SortingOrder, toIdMap, type IdMap, type Ref, type StatusCategory } from '@digitranslab/core'
  import type { IntlString } from '@digitranslab/platform'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import tracker, { type Issue, type Project } from '@digitranslab/tracker'
  import {
    createFocusManager,
    deviceOptionsStore,
    EditWithIcon,
