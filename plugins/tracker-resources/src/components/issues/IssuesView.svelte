<script lang="ts">
  import { DocumentQuery, Ref, Space, WithLookup } from '@digitranslab/core'
  import { Asset, IntlString, translateCB } from '@digitranslab/platform'
  import { ComponentExtensions } from '@digitranslab/presentation'
  import { Issue, TrackerEvents } from '@digitranslab/tracker'
  import { IModeSelector, themeStore } from '@digitranslab/ui'
  import { ViewOptions, Viewlet } from '@digitranslab/view'
  import { FilterBar, SpaceHeader, ViewletContentView, ViewletSettingButton } from '@digitranslab/view-resources'
