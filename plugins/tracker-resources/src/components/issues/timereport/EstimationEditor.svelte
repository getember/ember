...
-->
<script lang="ts">
  import { AttachedData } from '@digitranslab/core'

  import { getClient } from '@digitranslab/presentation'
  import { Issue, IssueDraft } from '@digitranslab/tracker'
  import { Button, ButtonKind, ButtonSize, eventToHTMLElement, showPopup } from '@digitranslab/ui'
  import { EditBoxPopup, FixedColumn } from '@digitranslab/view-resources'
