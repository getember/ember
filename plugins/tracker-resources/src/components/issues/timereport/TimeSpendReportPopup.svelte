...
<script lang="ts">
  ...
  import { AttachedData, Class, DocumentUpdate, Ref, Space } from '@digitranslab/core'
  ...
  import { Issue, TimeReportDayType, TimeSpendReport, TrackerEvents } from '@digitranslab/tracker'
  import { Button, DatePresenter, EditBox, Label } from '@digitranslab/ui'
