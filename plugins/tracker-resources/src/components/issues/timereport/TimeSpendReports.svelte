...
-->
<script lang="ts">
  import { DocumentQuery, SortingOrder } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import { Issue, TimeSpendReport } from '@digitranslab/tracker'
  import { Expandable, Label, Spinner, floorFractionDigits } from '@digitranslab/ui'
