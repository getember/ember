...
<script lang="ts">
  ...
  import { Ref, Space, WithLookup } from '@digitranslab/core'
  import { Project, TimeReportDayType, TimeSpendReport } from '@digitranslab/tracker'
  import {
    DatePresenter,
    ListView,
  ...
  import { FixedColumn, ListSelectionProvider, showMenu } from '@digitranslab/view-resources'
