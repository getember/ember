...
-->
<script lang="ts">
  import { NavLink } from '@digitranslab/presentation'
  import { trackerId, type Issue, type IssueParentInfo } from '@digitranslab/tracker'
  import { getCurrentLocation, locationToUrl } from '@digitranslab/ui'
