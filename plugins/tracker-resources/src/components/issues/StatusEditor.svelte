...
-->
<script lang="ts">
  import { AttachedData, Ref, WithLookup } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { getTaskTypeStates } from '@digitranslab/task'
  import { taskTypeStore } from '@digitranslab/task-resources'
  import { Issue, IssueDraft, IssueStatus, Project, TrackerEvents } from '@digitranslab/tracker'
  import {
    Button,
    ButtonKind,
    ButtonSize,
