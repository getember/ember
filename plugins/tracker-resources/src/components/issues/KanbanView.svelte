...
-->
<script lang="ts">
  import { AttachmentsPresenter } from '@digitranslab/attachment-resources'
  import {
    CategoryType,
    Class,
    Doc,
  ...
  import { Item, Kanban as KanbanUI } from '@digitranslab/kanban'
  import notification from '@digitranslab/notification'
  import { ActionContext, createQuery, getClient } from '@digitranslab/presentation'
  import tags from '@digitranslab/tags'
  import { DocWithRank, getStates } from '@digitranslab/task'
  import { getTaskKanbanResultQuery, typeStore, updateTaskKanbanCategories } from '@digitranslab/task-resources'
  import { Issue, IssuesGrouping, IssuesOrdering, Project } from '@digitranslab/tracker'
  import {
    Button,
    ColorDefinition,
    Component,
  ...
  import view, { AttributeModel, BuildModelKey, Viewlet, ViewOptionModel, ViewOptions } from '@digitranslab/view'
  import {
    enabledConfig,
    focusStore,
    ...
    showMenu,
    statusStore
  } from '@digitranslab/view-resources'
  import { ChatMessagesPresenter } from '@digitranslab/chunter-resources'
