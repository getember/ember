...
<script lang="ts">
  ...
  import { AttachmentDocList } from '@digitranslab/attachment-resources'
  import { ChatMessagePopup } from '@digitranslab/chunter-resources'
  import { Ref } from '@digitranslab/core'
  import { IconForward, createQuery, getClient } from '@digitranslab/presentation'
  import { CollaborativeTextEditor } from '@digitranslab/text-editor-resources'
  import { Issue } from '@digitranslab/tracker'
  import { Label, Scroller, resizeObserver } from '@digitranslab/ui'
  import { getCollaborationUser } from '@digitranslab/view-resources'
