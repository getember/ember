...
<script lang="ts">
  ...
  import { taskTypeStore } from '@digitranslab/task-resources'
  import TaskTypeIcon from '@digitranslab/task-resources/src/components/taskTypes/TaskTypeIcon.svelte'
  import type { Issue } from '@digitranslab/tracker'
  import { AnySvelteComponent, Icon, tooltip } from '@digitranslab/ui'
  import { DocNavLink, ObjectMention } from '@digitranslab/view-resources'
  import { ObjectPresenterType } from '@digitranslab/view'
