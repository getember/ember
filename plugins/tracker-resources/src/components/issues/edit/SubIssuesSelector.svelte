...
-->
<script lang="ts">
  import core, { IdMap, Ref, SortingOrder, StatusCategory, WithLookup, toIdMap } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import task, { getStates } from '@digitranslab/task'
  import { typeStore } from '@digitranslab/task-resources'
  import { Issue, Project } from '@digitranslab/tracker'
  import { Button, ButtonKind, ButtonSize, ProgressCircle, SelectPopup, showPanel } from '@digitranslab/ui'
