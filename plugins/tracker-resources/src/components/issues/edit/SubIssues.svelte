...
-->
<script lang="ts">
  import { Issue, trackerId } from '@digitranslab/tracker'
  import { Button, IconScaleFull, Label, closeTooltip, getCurrentResolvedLocation, navigate } from '@digitranslab/ui'
  import { createFilter, restrictionStore, setFilters } from '@digitranslab/view-resources'
