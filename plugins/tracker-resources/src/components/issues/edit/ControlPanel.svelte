...
<script lang="ts">
  ...
  import { EmployeeBox, personAccountByIdStore, personByIdStore } from '@digitranslab/contact-resources'
  import core, { Class, ClassifierKind, Doc, Mixin, Ref } from '@digitranslab/core'
  import { AttributeBarEditor, createQuery, getClient, KeyedAttribute } from '@digitranslab/presentation'

  import tags from '@digitranslab/tags'
  import type { Issue } from '@digitranslab/tracker'
  import { Component, Label } from '@digitranslab/ui'
  import { getFiltredKeys, isCollectionAttr, ObjectBox, restrictionStore } from '@digitranslab/view-resources'
