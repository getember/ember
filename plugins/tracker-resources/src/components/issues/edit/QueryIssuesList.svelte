...
-->
<script lang="ts">
  import core, { Class, Doc, DocumentQuery, Ref } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Issue } from '@digitranslab/tracker'
  import { Button, Chevron, ExpandCollapse, IconAdd, closeTooltip, resizeObserver, showPopup } from '@digitranslab/ui'
  import view, { ViewOptions, Viewlet, ViewletPreference } from '@digitranslab/view'
  import { ViewletsSettingButton, restrictionStore } from '@digitranslab/view-resources'
