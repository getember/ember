<script lang="ts">
  ...
  import presentation, { copyTextToClipboard, createQuery } from '@digitranslab/presentation'
  import { Issue, IssueStatus } from '@digitranslab/tracker'
  import { Button, Notification, navigate, parseLocation, NotificationToast } from '@digitranslab/ui'
