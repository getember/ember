...
<script lang="ts">
  ...
  import { AssigneeBox, AssigneePopup, personAccountByIdStore } from '@digitranslab/contact-resources'
  import { AssigneeCategory } from '@digitranslab/contact-resources/src/assignee'
  import { Account, Doc, DocumentQuery, Ref, Space, generateId } from '@digitranslab/core'
  import { RuleApplyResult, getClient, getDocRules } from '@digitranslab/presentation'
  import { Component, Issue, TrackerEvents } from '@digitranslab/tracker'
  import { ButtonKind, ButtonSize, IconSize, TooltipAlignment } from '@digitranslab/ui'
