...
import type { Class, Doc, Mixin, Ref, SpaceType, SpaceTypeDescriptor, Type } from '@digitranslab/core'
import type { Asset, IntlString, Plugin, Resource as PlatformResource } from '@digitranslab/platform'
