<script lang="ts">
  ...
  import { Label, Status as StatusControl, TextArea } from '@digitranslab/ui'
  import { Class, Client, Doc, Ref, generateId, AttachedData } from '@digitranslab/core'
  import { getResource, OK, Resource, Status } from '@digitranslab/platform'
  import { Card as Popup, getClient } from '@digitranslab/presentation'
