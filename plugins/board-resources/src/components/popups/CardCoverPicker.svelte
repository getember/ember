<script lang="ts">
  import { CardCover, Card } from '@digitranslab/board'
  import presentation, { Card as Popup, getClient } from '@digitranslab/presentation'
  import { Button, hexColorToNumber, Icon, Label, IconCheck } from '@digitranslab/ui'
