...
-->
<script lang="ts">
  import type { Card as BoardCard } from '@digitranslab/board'
  import board from '../../plugin'
  import task, { makeRank } from '@digitranslab/task'
  import { AttachedData, generateId, Ref, SortingOrder, Space } from '@digitranslab/core'
  import { IconAdd, Button, showPopup } from '@digitranslab/ui'
