...
<script lang="ts">
  ...
  import core, { Class, Doc, Mixin, Ref, Space } from '@digitranslab/core'
  ...
  import { Button, EditBox, IconMoreH } from '@digitranslab/ui'
  import { DocAttributeBar, ParentsNavigator, invokeAction, showMenu } from '@digitranslab/view-resources'
