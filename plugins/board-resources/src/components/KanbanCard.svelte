...
-->
<script lang="ts">
  import { AttachmentDroppable, AttachmentsPresenter } from '@digitranslab/attachment-resources'
  import type { Card } from '@digitranslab/board'
  import contact, { Employee } from '@digitranslab/contact'
  import type { Ref, WithLookup } from '@digitranslab/core'
  import notification from '@digitranslab/notification'
  import { ChatMessagesPresenter } from '@digitranslab/notification-resources'
  import { getClient } from '@digitranslab/presentation'
  import tags from '@digitranslab/tags'
  import { Button, Component, EditBox, Icon, IconMoreV, Label, numberToHexColor } from '@digitranslab/ui'
