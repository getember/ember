...
-->
<script lang="ts">
  import type { Board, Card as BoardCard } from '@digitranslab/board'
  import core, { AttachedData, Ref, SortingOrder, Space, generateId } from '@digitranslab/core'
  import { OK, Status } from '@digitranslab/platform'
  import { Card, SpaceSelector, createQuery, getClient } from '@digitranslab/presentation'
  import task, { TaskType, makeRank } from '@digitranslab/task'
  import { EditBox, Grid, Status as StatusControl } from '@digitranslab/ui'
