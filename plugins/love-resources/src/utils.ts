...
import calendar, { type Event, getAllEvents } from '@digitranslab/calendar'
import contact, { getName, type Person, type PersonAccount } from '@digitranslab/contact'
...
import { getEmbeddedLabel, getMetadata, getResource, type IntlString } from '@digitranslab/platform'
import presentation, {
  copyTextToClipboard,
  createQuery,
  type DocCreatePhase,
...
import { connectMeeting, disconnectMeeting } from '@digitranslab/ai-bot-resources'
import {
  openWidget,
  sidebarStore,
  updateWidgetState,
  ...
  openWidgetTab
} from '@digitranslab/workbench-resources'
import { type Widget, type WidgetTab } from '@digitranslab/workbench'
