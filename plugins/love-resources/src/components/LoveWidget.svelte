...
-->
<script lang="ts">
  import { AccountRole, getCurrentAccount, hasAccountRole, Ref } from '@digitranslab/core'
  import love, { Floor, Room } from '@digitranslab/love'
  import { Breadcrumbs, ButtonIcon, eventToHTMLElement, Header, IconAdd, Scroller, showPopup } from '@digitranslab/ui'
...
<div class="emberModal-container noTopIndent type-aside">
  <div class="emberModal-content">
    <Scroller>
