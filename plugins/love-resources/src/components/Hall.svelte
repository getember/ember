...
<script lang="ts">
  ...
  import love, { Floor as FloorType, Office, Room, RoomInfo, isOffice } from '@digitranslab/love'
  import { getClient } from '@digitranslab/presentation'
  import { deviceOptionsStore as deviceInfo, getCurrentLocation, navigate } from '@digitranslab/ui'
