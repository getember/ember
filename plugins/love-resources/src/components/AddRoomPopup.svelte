<script lang="ts">
  import core, { Class, Data, generateId, Ref } from '@digitranslab/core'
  import { translate } from '@digitranslab/platform'
  import { getClient } from '@digitranslab/presentation'
  import { Button, DropdownIntlItem } from '@digitranslab/ui'
  import { Floor, Office, Room, RoomAccess, RoomType, getFreePosition } from '@digitranslab/love'
