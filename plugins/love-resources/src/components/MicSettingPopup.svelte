<script lang="ts">
  import { getEmbeddedLabel, translate } from '@digitranslab/platform'
  import { DropdownLabels, DropdownTextItem, Label, Toggle } from '@digitranslab/ui'
  import { Room } from 'livekit-client'
  import love from '../plugin'
  import { getActive, krispProcessor, lk, selectedMicId, selectedSpeakerId } from '../utils'
  import { DevicesPreference } from '@digitranslab/love'
  import { getCurrentAccount, Ref, Space } from '@digitranslab/core'
