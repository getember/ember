...
-->
<script lang="ts">
  import { ActionIcon, Scroller, showPopup } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import { RoomType, Room as TypeRoom } from '@digitranslab/love'
  import {
    LocalParticipant,
  ...
  import { personIdByAccountId } from '@digitranslab/contact-resources'
