...
-->
<script lang="ts">
  import { PersonAccount, formatName } from '@digitranslab/contact'
  import { Avatar, personByIdStore } from '@digitranslab/contact-resources'
  import { getCurrentAccount } from '@digitranslab/core'
  import { getClient, playSound } from '@digitranslab/presentation'
  import { Button, Label } from '@digitranslab/ui'
  import { JoinRequest, RequestStatus } from '@digitranslab/love'
