...
<script lang="ts">
  ...
  import { personByIdStore, personIdByAccountId } from '@digitranslab/contact-resources'
  import { Room as TypeRoom } from '@digitranslab/love'
  import { getMetadata } from '@digitranslab/platform'
  import { Label, Loading, resizeObserver, deviceOptionsStore as deviceInfo } from '@digitranslab/ui'
  import {
    LocalParticipant,
