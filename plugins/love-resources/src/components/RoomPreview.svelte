...
<script lang="ts">
  ...
  import { isOffice, ParticipantInfo, Room, RoomAccess, RoomType, MeetingStatus } from '@digitranslab/love'
  import { Icon, Label, eventToHTMLElement, showPopup } from '@digitranslab/ui'
...
<div
  ...
  style:--ember-floor-roomWidth={room.width + extraRow}
