<script lang="ts">
  ...
  import core, { Class, Doc, Mixin, Ref } from '@digitranslab/core'
  ...
  import presentation, { createQuery, getClient, type KeyedAttribute } from '@digitranslab/presentation'
  import { type AnyComponent, Button, Component, IconMixin, IconMoreH, Label } from '@digitranslab/ui'
  import view, { AttributeCategory } from '@digitranslab/view'
  import {
    DocAttributeBar,
    DocNavLink,
