...
<script lang="ts">
  ...
  import { AvatarType, buildGravatarId, checkHasGravatar, type AvatarInfo } from '@digitranslab/contact'
  import type { Ref } from '@digitranslab/core'
  import { Blob as PlatformBlob } from '@digitranslab/core'
  import { Asset } from '@digitranslab/platform'
  import presentation, { Card, getFileUrl } from '@digitranslab/presentation'
  import {
    AnySvelteComponent,
    ColorDefinition,
    Label,
