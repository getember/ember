...
-->
<script lang="ts">
  import { AvatarType, Channel, combineName, ContactEvents, Person, PersonAccount } from '@digitranslab/contact'
  import core, { AccountRole, AttachedData, Data, generateId, Ref } from '@digitranslab/core'
  ...
  import { createFocusManager, EditBox, FocusHandler, IconInfo, Label } from '@digitranslab/ui'
