...
-->
<script lang="ts">
  import type { Channel, ChannelProvider } from '@digitranslab/contact'
  import contact from '@digitranslab/contact'
  import { AttachedData, Doc, Ref, toIdMap } from '@digitranslab/core'
  import notification, { DocNotifyContext, InboxNotification } from '@digitranslab/notification'
  import { Asset, IntlString, getResource } from '@digitranslab/platform'
  import presentation, { getClient } from '@digitranslab/presentation'
  import {
    Action,
    AnyComponent,
    Button,
  ...
  import view, { Action as ViewAction } from '@digitranslab/view'
  import { ContextMenu, invokeAction } from '@digitranslab/view-resources'
