...
<script lang="ts">
  ...
  import { Class, flipSet, getCurrentAccount, getObjectValue, Ref } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import { CheckBox, createFocusManager, FocusHandler, ListView } from '@digitranslab/ui'
