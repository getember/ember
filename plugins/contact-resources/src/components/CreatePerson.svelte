...
-->
<script lang="ts">
  import { AvatarType, Channel, combineName, ContactEvents, findPerson, Person } from '@digitranslab/contact'
  import { AttachedData, Data, generateId } from '@digitranslab/core'
