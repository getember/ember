...
<script lang="ts">
  ...
  import { AvatarType, type AvatarInfo } from '@digitranslab/contact'
  import { Asset, getResource } from '@digitranslab/platform'
  import { AnySvelteComponent, IconSize, showPopup } from '@digitranslab/ui'
  import { createEventDispatcher } from 'svelte'

  import type { Data, Blob as PlatformBlob, Ref, WithLookup } from '@digitranslab/core'
