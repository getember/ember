...
-->
<script lang="ts">
  import contact, { Employee, Person } from '@digitranslab/contact'
  import type { Class, DocumentQuery, FindOptions, Ref } from '@digitranslab/core'
  import type { IntlString } from '@digitranslab/platform'
  import presentation from '@digitranslab/presentation'
  import { ButtonKind, ButtonSize, IconSize, LabelAndProps } from '@digitranslab/ui'
