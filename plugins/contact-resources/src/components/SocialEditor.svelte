...
-->
<script lang="ts">
  import { AttachedData, Ref } from '@digitranslab/core'
  import { createEventDispatcher } from 'svelte'
  import { EditBox, Button, ScrollBox, Label } from '@digitranslab/ui'
  import { getClient } from '@digitranslab/presentation'

  import { ChannelProvider, Channel } from '@digitranslab/contact'
