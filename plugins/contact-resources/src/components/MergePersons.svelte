...
<script lang="ts">
  ...
  import { Channel, Person, getName } from '@digitranslab/contact'
  import core, {
    ArrOf,
    Doc,
    DocumentUpdate,
  ...
  import { Card, createQuery, getClient, updateAttribute } from '@digitranslab/presentation'
  import { Toggle } from '@digitranslab/ui'
  import { isCollectionAttr } from '@digitranslab/view-resources'
