<script lang="ts">
  ...
  import { ModernButton, navigate, resizeObserver } from '@digitranslab/ui'
...
>
  {#if employee}
    <div class="flex-presenter flex-gap-2 p-2">
      ...
      <span class="emberAvatar-statusMarker small relative mt-0-5" class:online={isOnline} class:offline={!isOnline} />
    </div>
    <div class="separator" />
    <div class="flex-presenter flex-gap-2 p-2">
