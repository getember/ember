...
-->
<script lang="ts">
  import type { AttachedData, Class, Doc, Ref } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { ButtonKind, ButtonSize, closeTooltip, showPopup } from '@digitranslab/ui'

  import { Channel, ChannelProvider } from '@digitranslab/contact'
  import { restrictionStore } from '@digitranslab/view-resources'
