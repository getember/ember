...
-->
<script lang="ts">
  import contact, { Contact, Employee, Person } from '@digitranslab/contact'
  import type { Class, Doc, DocumentQuery, Ref } from '@digitranslab/core'
  import type { IntlString } from '@digitranslab/platform'
  import { ObjectCreate, getClient } from '@digitranslab/presentation'
  import type { ButtonKind, ButtonSize, TooltipAlignment } from '@digitranslab/ui'
  import { Button, Label, showPopup } from '@digitranslab/ui'
