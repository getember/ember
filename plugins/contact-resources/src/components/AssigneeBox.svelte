...
-->
<script lang="ts">
  import contact, { Contact, Employee, Person, getName } from '@digitranslab/contact'
  import { Class, DocumentQuery, FindOptions, Ref } from '@digitranslab/core'
  import { IntlString, getEmbeddedLabel } from '@digitranslab/platform'
  import presentation, { getClient, reduceCalls } from '@digitranslab/presentation'
  import {
    ActionIcon,
    Button,
    ButtonKind,
