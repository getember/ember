...
<script lang="ts">
  ...
  import core, { Doc, FindResult, getObjectValue, Ref, SortingOrder, Space } from '@digitranslab/core'
  ...
  import { FILTER_DEBOUNCE_MS, FilterRemovedNotification, sortFilterValues } from '@digitranslab/view-resources'
