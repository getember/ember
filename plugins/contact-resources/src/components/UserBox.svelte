...
-->
<script lang="ts">
  import contact, { Contact, getName } from '@digitranslab/contact'
  import { Class, Doc, DocumentQuery, FindOptions, Ref } from '@digitranslab/core'
  import { Asset, IntlString, getEmbeddedLabel } from '@digitranslab/platform'
  import presentation, { ObjectCreate, getClient } from '@digitranslab/presentation'
  import {
    ActionIcon,
    AnySvelteComponent,
    Button,
