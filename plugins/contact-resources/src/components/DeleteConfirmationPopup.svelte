...
<script lang="ts">
  ...
  import { AccountRole, Doc, Ref, getCurrentAccount } from '@digitranslab/core'
  import { Card, isAdminUser } from '@digitranslab/presentation'
  import ui, { Button, Label } from '@digitranslab/ui'
