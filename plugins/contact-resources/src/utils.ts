...
import { type IntlString, getEmbeddedLabel, getResource, translate } from '@digitranslab/platform'
...
import view, { type Filter, type GrouppingManager } from '@digitranslab/view'
import { accessDeniedStore, FilterQuery } from '@digitranslab/view-resources'
