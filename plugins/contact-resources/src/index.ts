...
import { getResource, type IntlString, type Resources } from '@digitranslab/platform'
import { MessageBox, getBlobRef, getClient, type ObjectSearchResult } from '@digitranslab/presentation'
import {
...
import { AggregationManager } from '@digitranslab/view-resources'
