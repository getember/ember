...
import { OK, Severity, Status, type Resources } from '@digitranslab/platform'
import { createQuery, getClient, type ObjectSearchResult } from '@digitranslab/presentation'
import { type Applicant, type Candidate, type Vacancy } from '@digitranslab/recruit'
import contact from '@digitranslab/contact'
import task from '@digitranslab/task'
import { showPopup } from '@digitranslab/ui'
import { type Filter } from '@digitranslab/view'
import { FilterQuery, statusStore } from '@digitranslab/view-resources'
