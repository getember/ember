...
-->
<script lang="ts">
  import { AttachmentStyledBox } from '@digitranslab/attachment-resources'
  import chunter from '@digitranslab/chunter'
  import type { Contact, Employee, Person } from '@digitranslab/contact'
  import contact from '@digitranslab/contact'
  import { EmployeeBox, ExpandRightDouble, UserBox } from '@digitranslab/contact-resources'
  import {
    Account,
    AccountRole,
    Class,
  ...
  import { OK, Resource, Severity, Status, getResource } from '@digitranslab/platform'
  import presentation, {
    Card,
    InlineAttributeBar,
    SpaceSelect,
  ...
  import { recruitId, type Applicant, type Candidate, type Vacancy, RecruitEvents } from '@digitranslab/recruit'
  import task, { TaskType, getStates, makeRank } from '@digitranslab/task'
  import { TaskKindSelector, selectedTypeStore, typeStore } from '@digitranslab/task-resources'
  import { EmptyMarkup, isEmptyMarkup } from '@digitranslab/text'
  import ui, {
    Button,
    ColorPopup,
    FocusHandler,
