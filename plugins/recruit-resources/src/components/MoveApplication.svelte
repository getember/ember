...
<script lang="ts">
  ...
  import { ExpandRightDouble } from '@digitranslab/contact-resources'
  import { FindOptions, Status as TaskStatus } from '@digitranslab/core'
  import { OK, Severity, Status } from '@digitranslab/platform'
  import presentation, { Card, SpaceSelect, createQuery, getClient } from '@digitranslab/presentation'
  import type { Applicant, Vacancy } from '@digitranslab/recruit'
  import { getStates } from '@digitranslab/task'
  import { typeStore } from '@digitranslab/task-resources'
  import ui, {
    Button,
    ColorPopup,
    FocusHandler,
  ...
  import { moveToSpace } from '@digitranslab/view-resources/src/utils'
