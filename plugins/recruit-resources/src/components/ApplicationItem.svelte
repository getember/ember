...
-->
<script lang="ts">
  import contact, { getName, Person } from '@digitranslab/contact'
  import PersonPresenter from '@digitranslab/contact-resources/src/components/PersonPresenter.svelte'
  import { Ref } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import type { Applicant } from '@digitranslab/recruit'
