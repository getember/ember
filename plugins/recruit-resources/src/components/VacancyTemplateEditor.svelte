...
-->
<script lang="ts">
  import { AttributesBar, getClient } from '@digitranslab/presentation'
  import { ProjectType } from '@digitranslab/task'
  import { StyledTextBox } from '@digitranslab/text-editor-resources'
  import tracker from '@digitranslab/tracker'
  import { Button, Component, Icon, IconAdd, Label, showPopup } from '@digitranslab/ui'
  import { getFiltredKeys } from '@digitranslab/view-resources'
