...
-->
<script lang="ts">
  import calendar, { Calendar } from '@digitranslab/calendar'
  import type { Contact, PersonAccount, Organization, Person } from '@digitranslab/contact'
  ...
  import { getResource, OK, Resource, Severity, Status } from '@digitranslab/platform'
  import { Card, getClient } from '@digitranslab/presentation'
  import { UserBox, UserBoxList } from '@digitranslab/contact-resources'
  import { Applicant, Candidate, RecruitEvents, Review } from '@digitranslab/recruit'
  import task from '@digitranslab/task'
  import { EmptyMarkup } from '@digitranslab/text'
  import { StyledTextArea } from '@digitranslab/text-editor-resources'
  import { DateRangePresenter, EditBox, Status as StatusControl } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import { ObjectSearchBox } from '@digitranslab/view-resources'
