...
<script lang="ts">
  ...
  import { DateRangeMode, Doc, FindOptions, Ref } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { Applicant, Review } from '@digitranslab/recruit'
  import { Button, DatePresenter, IconAdd, Label, Scroller, showPopup } from '@digitranslab/ui'
