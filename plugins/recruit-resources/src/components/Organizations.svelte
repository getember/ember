...
-->
<script lang="ts">
  import { Organization } from '@digitranslab/contact'
  import core, { Doc, DocumentQuery, Ref, WithLookup } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import { Applicant, Vacancy } from '@digitranslab/recruit'
  import { Button, Component, IconAdd, Breadcrumb, Loading, SearchInput, showPopup, Header } from '@digitranslab/ui'
  import view, { BuildModelKey, ViewOptions, Viewlet, ViewletPreference } from '@digitranslab/view'
  import { FilterBar, FilterButton, ViewletSelector, ViewletSettingButton } from '@digitranslab/view-resources'
