...
<script lang="ts">
  ...
  import attachment, { AttachmentsEvents } from '@digitranslab/attachment'
  import contact, {
    AvatarType,
    Channel,
    ChannelProvider,
  ...
  import { getMetadata, getResource, setPlatformStatus, unknownError } from '@digitranslab/platform'
  import presentation, {
    Card,
    createQuery,
    deleteFile,
  ...
  import { Candidate, CandidateDraft, RecruitEvents } from '@digitranslab/recruit'
  import { recognizeDocument } from '@digitranslab/rekoni'
  import tags, { findTagCategory, TagElement, TagReference } from '@digitranslab/tags'
  import {
    Button,
    Component,
    createFocusManager,
