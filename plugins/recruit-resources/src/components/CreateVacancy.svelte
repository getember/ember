...
<script lang="ts">
  ...
  import contact, { Organization } from '@digitranslab/contact'
  import { AccountArrayEditor, UserBox } from '@digitranslab/contact-resources'
  import core, {
    Account,
    AttachedData,
    Data,
  ...
  import { RecruitEvents, Vacancy, Vacancy as VacancyClass } from '@digitranslab/recruit'
  import tags from '@digitranslab/tags'
  import task, { ProjectType, makeRank } from '@digitranslab/task'
  import { selectedTypeStore, typeStore } from '@digitranslab/task-resources'
  import tracker, { Issue, IssueStatus, IssueTemplate, IssueTemplateData, Project } from '@digitranslab/tracker'
  import {
    Button,
    Component,
    EditBox,
