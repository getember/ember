...
<script lang="ts">
  ...
  import { recruitId, Vacancy } from '@digitranslab/recruit'
  import { Button, Icon, IconAdd, Label, Loading, Scroller, showPopup } from '@digitranslab/ui'
  import { Viewlet, ViewletPreference } from '@digitranslab/view'
  import { NavLink, Table, ViewletsSettingButton } from '@digitranslab/view-resources'
