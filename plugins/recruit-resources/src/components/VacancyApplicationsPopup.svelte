...
-->
<script lang="ts">
  import core, { FindOptions, SortingOrder } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import { Applicant, Vacancy } from '@digitranslab/recruit'
  import { Button, Label, Loading } from '@digitranslab/ui'
  import view, { Viewlet, ViewletPreference } from '@digitranslab/view'
  import { DocNavLink, ObjectPresenter, Table } from '@digitranslab/view-resources'
