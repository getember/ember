...
-->
<script lang="ts">
  import { AttachmentStyleBoxCollabEditor } from '@digitranslab/attachment-resources'
  import core, { ClassifierKind, type CollaborativeDoc, Data, Doc, Mixin, Ref } from '@digitranslab/core'
  ...
  import { Vacancy } from '@digitranslab/recruit'
  import survey from '@digitranslab/survey'
  import tracker from '@digitranslab/tracker'
  import { Button, Component, EditBox, IconMixin, IconMoreH, Label } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import { DocAttributeBar, DocNavLink, showMenu } from '@digitranslab/view-resources'
