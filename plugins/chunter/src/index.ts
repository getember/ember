...
import { ActivityMessage, ActivityMessageViewlet } from '@digitranslab/activity'
import type { AttachedDoc, Class, Doc, Markup, Mixin, Ref, Space, Timestamp } from '@digitranslab/core'
import { NotificationType } from '@digitranslab/notification'
import type { Asset, Plugin, Resource } from '@digitranslab/platform'
import { IntlString, plugin } from '@digitranslab/platform'
import { AnyComponent } from '@digitranslab/ui'
import { Action } from '@digitranslab/view'
import { Person, ChannelProvider as SocialChannelProvider } from '@digitranslab/contact'
import { Widget, WidgetTab } from '@digitranslab/workbench'
