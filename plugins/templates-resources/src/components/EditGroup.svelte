...
-->
<script lang="ts">
  import { SpaceMembers } from '@digitranslab/contact-resources'
  ...
  import { TemplateCategory } from '@digitranslab/templates'
  import { EditBox, Grid, Label } from '@digitranslab/ui'
  import { BooleanPresenter } from '@digitranslab/view-resources'
