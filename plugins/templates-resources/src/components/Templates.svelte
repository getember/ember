<script lang="ts">
  import core, { Data, Ref } from '@digitranslab/core'
  import { getEmbeddedLabel, getResource } from '@digitranslab/platform'
  import { createQuery, getClient, MessageViewer, SpaceSelector } from '@digitranslab/presentation'
  import { MessageTemplate, TemplateCategory } from '@digitranslab/templates'
  ...
  import { getActions as getContributedActions, TreeItem, TreeNode } from '@digitranslab/view-resources'
  ...
  <div class="emberComponent-content__container columns">
    ...
    <div class="emberComponent-content__column content">
      <Scroller align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
        <div class="emberComponent-content">
          {#if newTemplate}
