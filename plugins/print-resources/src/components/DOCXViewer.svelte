...
<script lang="ts">
  import { type Blob, type Ref } from '@digitranslab/core'
  import { getMetadata } from '@digitranslab/platform'
  import presentation, { BlobMetadata, getFileUrl } from '@digitranslab/presentation'
  import { Spinner, themeStore } from '@digitranslab/ui'
  import { convertToHTML } from '@digitranslab/print'
