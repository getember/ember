...
import type { Class, Doc, Markup, Ref, Space } from '@digitranslab/core'
import type { IntlString, Plugin, Resource } from '@digitranslab/platform'
import { Asset, plugin } from '@digitranslab/platform'
