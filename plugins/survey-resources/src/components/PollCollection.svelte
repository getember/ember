...
-->
<script lang="ts">
  import type { Class, Doc, Ref, Space } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Survey } from '@digitranslab/survey'
  import { Button, IconAdd, Label, Section, navigate, showPopup } from '@digitranslab/ui'
  import view, { Viewlet, ViewletPreference } from '@digitranslab/view'
  import { Table, ViewletSelector, ViewletSettingButton, getObjectLinkFragment } from '@digitranslab/view-resources'
