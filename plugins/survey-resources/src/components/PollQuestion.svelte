...
-->
<script lang="ts">
  import { generateId } from '@digitranslab/core'
  import { EditBox, Icon, Label, tooltip, ModernCheckbox, ModernRadioButton } from '@digitranslab/ui'
  import { AnsweredQuestion, QuestionKind } from '@digitranslab/survey'
