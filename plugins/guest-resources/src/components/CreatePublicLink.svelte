...
-->
<script lang="ts">
  import { Doc, Timestamp } from '@digitranslab/core'
  import { PublicLink, createPublicLink } from '@digitranslab/guest'
  import presentaion, {
    Card,
    MessageBox,
    copyTextToClipboard,
  ...
  import { Button, Loading, showPopup, ticker } from '@digitranslab/ui'
