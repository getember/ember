...
<script lang="ts">
  ...
  import core, { Class, Doc, Ref, Space } from '@digitranslab/core'
  import { getMetadata, getResource } from '@digitranslab/platform'
  import { ActionContext, decodeTokenPayload, getClient } from '@digitranslab/presentation'
  import {
    AnyComponent,
    Component,
    Label,
  ...
  import { ListSelectionProvider, parseLinkId, restrictionStore, updateFocus } from '@digitranslab/view-resources'
  import workbench, { Application, NavigatorModel, SpecialNavModel, ViewConfiguration } from '@digitranslab/workbench'
  import { SpaceView, buildNavModel } from '@digitranslab/workbench-resources'
