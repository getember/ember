...
-->
<script lang="ts">
  import { Class, Doc, getCurrentAccount, Ref } from '@digitranslab/core'
  import notification, { BrowserNotification } from '@digitranslab/notification'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { addNotification, getCurrentResolvedLocation, Location, NotificationSeverity } from '@digitranslab/ui'
  ...
  import workbench, { Application } from '@digitranslab/workbench'
