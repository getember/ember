...
<script lang="ts">
  ...
  import { Class, Doc, getCurrentAccount, groupByArray, Ref, SortingOrder } from '@digitranslab/core'
  import { DocNotifyContext, InboxNotification, notificationId } from '@digitranslab/notification'
  ...
  import view, { decodeObjectURI } from '@digitranslab/view'
  import { parseLinkId } from '@digitranslab/view-resources'
  ...
  {#if $deviceInfo.navigator.visible}
    ...
    >
      <div class="antiPanel-wrap__content emberNavPanel-container">
        <div class="emberNavPanel-header withButton small">
    ...
    />
  {/if}
  <div bind:this={replacedPanel} class="emberComponent">
