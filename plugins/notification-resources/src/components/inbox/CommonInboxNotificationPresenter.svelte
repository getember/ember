...
-->
<script lang="ts">
  import { BasePreview } from '@digitranslab/activity-resources'
  import { Doc, Markup } from '@digitranslab/core'
  import { CommonInboxNotification } from '@digitranslab/notification'
