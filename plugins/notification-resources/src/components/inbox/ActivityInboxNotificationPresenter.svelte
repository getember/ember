...
<script lang="ts">
  ...
  import { Ref, Space, matchQuery, Doc } from '@digitranslab/core'
  import notification, {
  ...
  import { ActivityMessage, DisplayActivityMessage } from '@digitranslab/activity'
  import { Action, Component } from '@digitranslab/ui'
  import { getActions } from '@digitranslab/view-resources'
