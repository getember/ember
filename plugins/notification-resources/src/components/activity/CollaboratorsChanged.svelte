...
<script lang="ts">
  import { Icon, IconAdd, IconDelete, Label } from '@digitranslab/ui'
  import { personAccountByIdStore, PersonAccountRefPresenter } from '@digitranslab/contact-resources'
  import { Person, PersonAccount } from '@digitranslab/contact'
  import { Ref } from '@digitranslab/core'
  import activity, { DocAttributeUpdates } from '@digitranslab/activity'
