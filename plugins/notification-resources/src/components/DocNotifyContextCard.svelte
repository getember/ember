...
-->
<script lang="ts">
  import { ButtonIcon, CheckBox, Component, IconMoreV, Label, Loading, showPopup, Spinner } from '@digitranslab/ui'
  import notification, {
  ...
  import { getDocTitle, getDocIdentifier, Menu } from '@digitranslab/view-resources'
  import { createEventDispatcher } from 'svelte'
  import { Class, Doc, IdMap, Ref, WithLookup } from '@digitranslab/core'
