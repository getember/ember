<script lang="ts">
  ...
  import { BrowserNotification } from '@digitranslab/notification'
  import { Button, navigate, Notification as PlatformNotification, NotificationToast } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import chunter, { ThreadMessage } from '@digitranslab/chunter'
