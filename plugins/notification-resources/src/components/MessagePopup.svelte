...
<script lang="ts">
  ...
  import { Lazy, Spinner } from '@digitranslab/ui'
  import { ActivityMessagePresenter, canGroupMessages } from '@digitranslab/activity-resources'
  import { ActivityInboxNotification, InboxNotification } from '@digitranslab/notification'
