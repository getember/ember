import contact, { type Employee, type PersonAccount, getFirstName, getLastName } from '@digitranslab/contact'
import { employeeByIdStore } from '@digitranslab/contact-resources'
import { type Class, type Doc, type Hierarchy, type Ref } from '@digitranslab/core'
