...
<script lang="ts">
  ...
  import { AccountRole, getCurrentAccount, hasAccountRole } from '@digitranslab/core'
  import login, { loginId } from '@digitranslab/login'
  import { setMetadata } from '@digitranslab/platform'
  import presentation, { closeClient, getClient, createQuery } from '@digitranslab/presentation'
  import settingPlg from '../plugin'
  import setting, { SettingsCategory, SettingsEvents } from '@digitranslab/setting'
  import {
    Component,
    Label,
    NavGroup,
  ...
  import { closeWidget, NavFooter, openWidget, minimizeSidebar } from '@digitranslab/workbench-resources'
...
>
  {#if $deviceInfo.navigator.visible}
    ...
    >
      <div class="antiPanel-wrap__content emberNavPanel-container">
        <div class="emberNavPanel-header">
  ...
  {#if asideComponent != null && !moveASide}
    ...
    <div class="emberSidePanel-container">
      {#key asideProps}
