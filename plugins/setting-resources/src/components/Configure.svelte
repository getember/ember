...
-->
<script lang="ts">
  import { PluginConfiguration } from '@digitranslab/core'
  import { configurationStore, getClient } from '@digitranslab/presentation'
  import { Button, Icon, IconInfo, Label, Header, Breadcrumb, Scroller } from '@digitranslab/ui'
