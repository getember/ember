...
-->
<script lang="ts">
  import core, { Enum } from '@digitranslab/core'
  import presentation, { getClient, MessageBox } from '@digitranslab/presentation'
  import {
    IconAdd,
    IconAttachment,
    IconDelete,
  ...
  import type { DropdownIntlItem } from '@digitranslab/ui'
...
>
  <div class="flex-col">
    ...
    <div
      class="emberTableAttr-container mt-6"
    ...
    >
      ...
      {#if values.length > 0 || newItem}
        <div class="emberTableAttr-content options">
          <EnumValuesList
            bind:values
          ...
          />
          {#if newItem}
            <div class="emberTableAttr-content__row hovered">
              <div class="emberTableAttr-content__row-dragMenu">
                <IconMoreV2 size={'small'} />
              </div>
              <div class="emberTableAttr-content__row-label font-regular-14 accent grow">
                <ModernEditbox
                  kind={'ghost'}
                  size={'small'}
              ...
              {#if matched}
                <div class="emberChip-item error font-medium-12">
