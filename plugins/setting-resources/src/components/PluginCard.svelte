...
<script lang="ts">
  ...
  import type { Integration, IntegrationType } from '@digitranslab/setting'
  import { AnyComponent, Button, Component, Label, eventToHTMLElement, showPopup } from '@digitranslab/ui'
