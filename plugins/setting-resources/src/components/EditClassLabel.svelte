...
-->
<script lang="ts">
  import core, { Class, Doc, DocumentUpdate, Tx, TxCreateDoc, TxUpdateDoc } from '@digitranslab/core'
  import { getEmbeddedLabel, IntlString } from '@digitranslab/platform'
  import presentation, { Card, createQuery, getClient } from '@digitranslab/presentation'
  import { Button, EditBox, Label } from '@digitranslab/ui'
