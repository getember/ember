...
<script lang="ts">
  ...
  import { getCurrentAccount, hasAccountRole } from '@digitranslab/core'
  import { createQuery, isAdminUser } from '@digitranslab/presentation'
  import setting, { SettingsCategory } from '@digitranslab/setting'
  import {
    Component,
    Location,
    NavItem,
