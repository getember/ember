...
-->
<script lang="ts">
  import contact, { Employee, PersonAccount, combineName, getFirstName, getLastName } from '@digitranslab/contact'
  import { ChannelsEditor, EditableAvatar, employeeByIdStore, personByIdStore } from '@digitranslab/contact-resources'
  ...
  import { AttributeEditor, MessageBox, getClient } from '@digitranslab/presentation'
  import { Breadcrumb, Button, EditBox, FocusHandler, Header, createFocusManager, showPopup } from '@digitranslab/ui'
