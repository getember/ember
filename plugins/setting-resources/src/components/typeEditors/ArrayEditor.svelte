...
-->
<script lang="ts">
  import core, { ArrOf, Class, Doc, Ref, Type } from '@digitranslab/core'
  import { ArrOf as createArrOf } from '@digitranslab/model'
  import { getClient } from '@digitranslab/presentation'
  import { AnyComponent, Component, DropdownLabelsIntl, Label } from '@digitranslab/ui'
