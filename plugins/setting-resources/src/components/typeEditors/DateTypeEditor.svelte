...
-->
<script lang="ts">
  import { DateRangeMode, TypeDate as DateType } from '@digitranslab/core'
  import { TypeDate } from '@digitranslab/model'
  import { IntlString } from '@digitranslab/platform'
  import { DropdownLabelsIntl, Label, DropdownIntlItem } from '@digitranslab/ui'
