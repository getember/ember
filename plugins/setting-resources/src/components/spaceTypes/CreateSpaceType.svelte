...
<script lang="ts">
  ...
  import core, { Class, Ref, SpaceTypeDescriptor, generateId, SpaceType, Data } from '@digitranslab/core'
  import { Card, getClient, hasResource } from '@digitranslab/presentation'
  import { AnySvelteComponent, EditBox } from '@digitranslab/ui'
  import { Resource, getResource } from '@digitranslab/platform'
  import { ObjectBox } from '@digitranslab/view-resources'
  import setting, { SpaceTypeCreator, createSpaceType } from '@digitranslab/setting'
