...
-->
<script lang="ts">
  import { AttributeEditor, MessageBox, createQuery, getClient } from '@digitranslab/presentation'
  import core, { Permission, Ref, Role, SpaceType, SpaceTypeDescriptor } from '@digitranslab/core'
  import {
    ButtonIcon,
    Icon,
    IconDelete,
  ...
  import { ObjectBoxPopup } from '@digitranslab/view-resources'
  import { deleteSpaceTypeRole } from '@digitranslab/setting'
    ...
    <div class="emberComponent-content__column content">
      <Scroller align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
        <div class="emberComponent-content gap">
          <div class="emberComponent-content__column-group mt-4">
            <div class="emberComponent-content__header mb-6 gap-2">
              <ButtonIcon
                icon={IconDelete}
                size="large"
                kind="secondary"
            ...
            <div class="emberTableAttr-container">
              <div class="emberTableAttr-header font-medium-12">
              ...
              {#if permissions.length > 0}
                <div class="emberTableAttr-content task">
                  {#each permissions as permission}
                    <div class="emberTableAttr-content__row">
                      {#if permission.icon !== undefined}
                        <div class="emberTableAttr-content__row-icon-wrapper">
                          <Icon icon={permission.icon} size="small" />
                        </div>
                      {/if}

                      <div class="emberTableAttr-content__row-label font-medium-14">
                        <Label label={permission.label} />
                      </div>

                      {#if permission.description !== undefined}
                        <div class="emberTableAttr-content__row-label grow dark font-regular-14">
