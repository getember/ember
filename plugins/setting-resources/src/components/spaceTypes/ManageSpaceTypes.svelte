...
<script lang="ts">
  ...
  import core, { Ref, SpaceType, WithLookup } from '@digitranslab/core'
  import { Location, getCurrentResolvedLocation, navigate, resolvedLocationStore } from '@digitranslab/ui'
  import { createQuery, hasResource } from '@digitranslab/presentation'
  import { Resource } from '@digitranslab/platform'
