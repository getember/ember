...
<script lang="ts">
  ...
  import { createSpaceTypeRole } from '@digitranslab/setting'
  import { Modal, ModernEditbox } from '@digitranslab/ui'
  import { AttachedData, Role, SpaceType } from '@digitranslab/core'
