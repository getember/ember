...
<script lang="ts">
  ...
  import core, { Account, reduceCalls, Ref, type SpaceType, type SpaceTypeDescriptor } from '@digitranslab/core'
...
{#if descriptor !== undefined}
  <div class="emberComponent-content__column-group">
    <div class="emberComponent-content__header">
