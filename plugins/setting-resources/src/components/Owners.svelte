...
<script lang="ts">
  ...
  import { EmployeePresenter, employeesStore } from '@digitranslab/contact-resources'
  ...
  import { Breadcrumb, DropdownIntlItem, DropdownLabelsIntl, SearchInput, Header, Scroller } from '@digitranslab/ui'
