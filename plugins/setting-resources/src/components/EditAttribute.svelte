...
-->
<script lang="ts">
  import core, { AnyAttribute, Class, DocumentUpdate, IndexKind, PropertyType, Ref, Type } from '@digitranslab/core'
  import { getEmbeddedLabel, getResource, translateCB } from '@digitranslab/platform'
