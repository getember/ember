...
-->
<script lang="ts">
  import core, { Class, Doc, Obj, Ref, isOwnerOrMaintainer } from '@digitranslab/core'
...
<div class="emberComponent">
  ...
  <div class="emberComponent-content__container columns">
    <div class="emberComponent-content__column">
      <div class="emberComponent-content__navHeader divide">
        <div class="emberComponent-content__navHeader-menu">
          <ButtonIcon kind={'tertiary'} icon={IconDescription} size={'small'} inheritColor />
        </div>
        <div class="emberComponent-content__navHeader-hint paragraph-regular-14">
