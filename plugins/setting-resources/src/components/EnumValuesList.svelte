...
{#each values as item, i}
  ...
  >
    <button class="emberTableAttr-content__row-dragMenu" class:drag={!disableMouseOver}>
      <IconMoreV2 size={'small'} />
    </button>
    <div class="emberTableAttr-content__row-label font-regular-14 accent">
      {item}
    </div>
    <div class="emberTableAttr-content__row-label grow" />
    {#if !disableMouseOver}
      <ButtonIcon
        kind={'tertiary'}
        icon={IconMoreV}
