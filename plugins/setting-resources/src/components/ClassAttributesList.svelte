...
<script lang="ts">
  ...
  import core, { AnyAttribute, ArrOf, AttachedDoc, Class, Collection, Doc, Ref, RefTo, Type } from '@digitranslab/core'
  import { IntlString, getResource } from '@digitranslab/platform'
  import presentation, { MessageBox, createQuery, getClient } from '@digitranslab/presentation'
  import {
    Action,
    AnySvelteComponent,
    IconDelete,
  ...
  import { getContextActions } from '@digitranslab/view-resources'
