...
-->
<script lang="ts">
  import core, { AnyAttribute, Class, ClassifierKind, Doc, Ref, Space } from '@digitranslab/core'
...
{/if}
<div
  class="emberTableAttr-container"
...
>
  <div class="emberTableAttr-header font-medium-12" class:withButton={showHierarchy}>
    {#if showHierarchy}
  ...
  {:else if hasCustomAttributes(_class)}
    <div class="emberTableAttr-content class">
      <ClassAttributesList
        {_class}
        {ofClass}
        {attributeMapper}
