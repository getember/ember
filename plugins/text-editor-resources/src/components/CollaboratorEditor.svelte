...
<script lang="ts">
  ...
  import { AnySvelteComponent, IconSize, registerFocus } from '@digitranslab/ui'
  import { AnyExtension, FocusPosition } from '@tiptap/core'
  import textEditor, { CollaborationUser, TextEditorCommandHandler } from '@digitranslab/text-editor'
