<script lang="ts">
  ...
  import presentation, { MessageViewer, getFileUrl, getImageSize, imageSizeToRatio } from '@digitranslab/presentation'
  import { EmptyMarkup } from '@digitranslab/text'
  import textEditor, { RefAction } from '@digitranslab/text-editor'
  import {
    ActionIcon,
    ButtonSize,
    IconCheck,
