...
<script lang="ts">
  ...
  import { encodeDocumentId } from '@digitranslab/collaborator-client'
  import { getAttribute, getClient, KeyedAttribute } from '@digitranslab/presentation'
  import { CollaborationIds } from '@digitranslab/text-editor'
