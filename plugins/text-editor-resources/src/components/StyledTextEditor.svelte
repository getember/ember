...
<script lang="ts">
  ...
  import { Button, type ButtonSize, Scroller } from '@digitranslab/ui'
  import { AnyExtension, mergeAttributes, type Editor } from '@tiptap/core'
  import { createEventDispatcher } from 'svelte'
  import textEditor, { RefAction, TextEditorHandler, TextFormatCategory } from '@digitranslab/text-editor'
