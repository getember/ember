...
<script lang="ts">
  import { Icon, Label, navigate } from '@digitranslab/ui'
  import { Table } from '@digitranslab/view-resources'
  import { type Training } from '@digitranslab/training'
  import { Attachments, AttachmentStyleBoxEditor } from '@digitranslab/attachment-resources'
  import { AttributeBarEditor, getClient } from '@digitranslab/presentation'
