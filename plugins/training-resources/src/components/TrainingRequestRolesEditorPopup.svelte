...
<script lang="ts">
  import core, { type DocumentQuery, type FindOptions, type Ref, type Role, SortingOrder } from '@digitranslab/core'
  import presentation, { ObjectPopup } from '@digitranslab/presentation'
