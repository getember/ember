...
<script lang="ts">
  ...
  import { Button, IconMoreH, type IModeSelector, navigate, rawLocation } from '@digitranslab/ui'
  import view, { type Action } from '@digitranslab/view'
  import { ActionButton, showMenu } from '@digitranslab/view-resources'
