...
<script lang="ts">
  import { Class, Ref, type WithLookup } from '@digitranslab/core'
  import { Panel } from '@digitranslab/panel'
  import { ActionContext, createQuery } from '@digitranslab/presentation'
  import { Button, IconMoreH, navigate, type IModeSelector, rawLocation } from '@digitranslab/ui'
  import view from '@digitranslab/view'
  import { showMenu } from '@digitranslab/view-resources'
  import { type Training, type TrainingAttempt, type TrainingRequest } from '@digitranslab/training'
