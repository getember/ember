...
import { isEnum, isId } from '@digitranslab/core'
import { type TrainingAttempt, trainingId } from '@digitranslab/training'
import { getClient } from '@digitranslab/presentation'
import { getCurrentLocation, type Location, type ResolvedLocation } from '@digitranslab/ui'
