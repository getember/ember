...
-->
<script lang="ts">
  import workbench, { Widget, WidgetTab } from '@digitranslab/workbench'
  import { FilePreview, DownloadFileButton, FilePreviewPopup, FileTypeIcon } from '@digitranslab/presentation'
  import { Breadcrumbs, Button, closeTooltip, Header, showPopup } from '@digitranslab/ui'
