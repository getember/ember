...
<script lang="ts">
  ...
  import { Account, Class, Doc, IdMap, Markup, Ref, Space, generateId, toIdMap } from '@digitranslab/core'
  import { Asset, IntlString, setPlatformStatus, unknownError } from '@digitranslab/platform'
  import {
    DraftController,
    createQuery,
    deleteFile,
  ...
  import { AttachIcon, ReferenceInput } from '@digitranslab/text-editor-resources'
  import { EmptyMarkup } from '@digitranslab/text'
  import { Loading, type AnySvelteComponent } from '@digitranslab/ui'
