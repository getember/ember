...
-->
<script lang="ts">
  import { Photo } from '@digitranslab/attachment'
  import { Class, Doc, Ref, Space, type WithLookup } from '@digitranslab/core'
  import { setPlatformStatus, unknownError } from '@digitranslab/platform'
  import { createQuery, getBlobRef, getClient, uploadFile } from '@digitranslab/presentation'
  import { Button, IconAdd, Label, Spinner } from '@digitranslab/ui'
