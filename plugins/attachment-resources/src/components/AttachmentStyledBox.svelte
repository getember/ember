...
-->
<script lang="ts">
  import { Attachment, BlobMetadata } from '@digitranslab/attachment'
  import {
    Account,
    Class,
    Doc,
  ...
  import { IntlString, setPlatformStatus, unknownError } from '@digitranslab/platform'
  import {
    createQuery,
    deleteFile,
    DraftController,
  ...
  import textEditor, { type RefAction } from '@digitranslab/text-editor'
  import { AttachIcon, StyledTextBox } from '@digitranslab/text-editor-resources'
  import { ButtonSize } from '@digitranslab/ui'
