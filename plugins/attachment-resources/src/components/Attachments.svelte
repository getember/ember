...
<script lang="ts">
  ...
  import { Class, Data, Doc, DocumentQuery, Ref, Space } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { Icon, Label, resizeObserver, Scroller, Spinner, ButtonIcon, IconAdd } from '@digitranslab/ui'
  import view, { BuildModelKey } from '@digitranslab/view'
  import { Table } from '@digitranslab/view-resources'
  import { getClient } from '@digitranslab/presentation'
  import { FileUploadCallbackParams, uploadFiles } from '@digitranslab/uploader'
