...
<script lang="ts">
  ...
  import core, { Class, getCurrentAccount, Ref, Space } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Label, Loading, navigate, TabList, SearchEdit, getLocation } from '@digitranslab/ui'
...
{/if}
<div class="emberHeader-container background-comp-header-color">
  <FileBrowserFilters
...
<div class="emberHeader-container justify-between">
