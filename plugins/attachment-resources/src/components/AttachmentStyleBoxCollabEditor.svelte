...
-->
<script lang="ts">
  import attachment, { Attachment, BlobMetadata, AttachmentsEvents } from '@digitranslab/attachment'
  import contact from '@digitranslab/contact'
  import { Account, Doc, Ref, generateId, type Blob } from '@digitranslab/core'
  import { IntlString, getResource, setPlatformStatus, unknownError } from '@digitranslab/platform'
  import {
    FileOrBlob,
    KeyedAttribute,
    createQuery,
  ...
  import textEditor, { type RefAction, type TextEditorHandler } from '@digitranslab/text-editor'
  import {
    AttachIcon,
    ...
    defaultRefActions,
    getModelRefActions
  } from '@digitranslab/text-editor-resources'
  import { AnySvelteComponent, getEventPositionElement, getPopupPositionElement, navigate } from '@digitranslab/ui'
  import { type FileUploadCallbackParams, uploadFiles } from '@digitranslab/uploader'
  import view from '@digitranslab/view'
  import { getCollaborationUser, getObjectId, getObjectLinkFragment } from '@digitranslab/view-resources'
