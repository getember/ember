...
<script lang="ts">
  ...
  import { createQuery, getClient, getFileMetadata, uploadFile } from '@digitranslab/presentation'
  import { ActionIcon, IconAdd, Label, Loading } from '@digitranslab/ui'

  import type { Doc, WithLookup } from '@digitranslab/core'
