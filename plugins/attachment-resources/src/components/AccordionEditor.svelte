...
<script lang="ts">
  ...
  import { Doc, Ref, Space, Class } from '@digitranslab/core'
  import { Button, Label, IconDownOutline, tooltip } from '@digitranslab/ui'
  import textEditorPlugin from '@digitranslab/text-editor'
  import { IsEmptyContentExtension, TextEditor } from '@digitranslab/text-editor-resources'
