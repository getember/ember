...
<script lang="ts">
  ...
  import presentation, { canPreviewFile, getFileUrl, previewTypes } from '@digitranslab/presentation'
  import { IconMoreH, Menu, Action as UIAction, showPopup, tooltip } from '@digitranslab/ui'
