...
<script lang="ts">
  ...
  import { Class, Ref, Space } from '@digitranslab/core'
  import { SpaceMultiBoxList } from '@digitranslab/presentation'
  import { Component, DropdownLabelsIntl } from '@digitranslab/ui'
