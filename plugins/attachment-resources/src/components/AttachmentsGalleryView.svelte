...
<script lang="ts">
  ...
  import { Doc, getCurrentAccount, type WithLookup } from '@digitranslab/core'
  import { getClient, getFileUrl } from '@digitranslab/presentation'
  import { Icon, IconMoreV, Menu, showPopup } from '@digitranslab/ui'
