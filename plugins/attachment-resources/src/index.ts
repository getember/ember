...
import activity, { type ActivityMessage, type DocUpdateMessage } from '@digitranslab/activity'
import attachment, { type Attachment } from '@digitranslab/attachment'
import core, { SortingOrder, type Markup, type ObjQueryType, type SortingQuery } from '@digitranslab/core'
import { type IntlString, type Resources } from '@digitranslab/platform'
import { PDFViewer, deleteFile, getClient, uploadFile } from '@digitranslab/presentation'
