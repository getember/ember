...
import { type BlobMetadata, type Attachment, type Drawing } from '@digitranslab/attachment'
import core, {
  SortingOrder,
  type Blob,
  type Class,
...
import { closeTooltip, showPopup, type PopupResult } from '@digitranslab/ui'
import workbench, { type WidgetTab } from '@digitranslab/workbench'
