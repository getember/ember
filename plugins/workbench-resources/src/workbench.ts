...
import { type Application, workbenchId, type WorkbenchTab } from '@digitranslab/workbench'
import {
...
import { type Asset, type IntlString, getMetadata, getResource, translate } from '@digitranslab/platform'
