<script lang="ts">
  ...
  import { groupByArray, systemAccountEmail } from '@digitranslab/core'
  import { getEmbeddedLabel, getMetadata } from '@digitranslab/platform'
  import presentation, { createQuery, isAdminUser, type OverviewStatistics } from '@digitranslab/presentation'
  import { Button, CheckBox, ticker } from '@digitranslab/ui'
  import Expandable from '@digitranslab/ui/src/components/Expandable.svelte'
