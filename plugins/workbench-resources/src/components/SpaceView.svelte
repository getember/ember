...
-->
<script lang="ts">
  import core, { Class, Doc, Ref, Space, WithLookup } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { getClient, reduceCalls } from '@digitranslab/presentation'
  import { AnyComponent, Component, resolvedLocationStore } from '@digitranslab/ui'
  ...
  import type { ViewConfiguration } from '@digitranslab/workbench'
