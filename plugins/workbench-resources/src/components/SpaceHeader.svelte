...
-->
<script lang="ts">
  import type { Class, Doc, DocumentQuery, Ref, Space } from '@digitranslab/core'
  import core, { WithLookup } from '@digitranslab/core'
  import { IntlString, Asset } from '@digitranslab/platform'
  ...
  import view, { ViewOptions, Viewlet } from '@digitranslab/view'
  import {
    FilterButton,
    ViewletSelector,
...
{:else}
  <div class="emberHeader-container" />
{/if}
