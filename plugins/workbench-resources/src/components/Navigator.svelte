...
-->
<script lang="ts">
  import core, { Doc, Ref, SortingOrder, Space, getCurrentAccount, hasAccountRole } from '@digitranslab/core'
  import { getResource } from '@digitranslab/platform'
  import preference, { SpacePreference } from '@digitranslab/preference'
  import { createQuery, getClient, isAdminUser } from '@digitranslab/presentation'
  import { Scroller, NavItem } from '@digitranslab/ui'
  import { NavLink } from '@digitranslab/view-resources'
  import type { Application, NavigatorModel, SpecialNavModel } from '@digitranslab/workbench'
