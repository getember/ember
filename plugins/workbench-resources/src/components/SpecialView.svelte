...
<script lang="ts">
  ...
  import { Class, Doc, DocumentQuery, Ref, Space, WithLookup } from '@digitranslab/core'
  import { IntlString, Asset, getResource } from '@digitranslab/platform'
  ...
  import { ParentsNavigationModel } from '@digitranslab/workbench'
