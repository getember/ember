...
<script lang="ts">
  ...
  import support, { docsLink, reportBugLink, supportLink, privacyPolicyLink } from '@digitranslab/support'
  import {
    AnySvelteComponent,
    Button,
    Icon,
  ...
  import view, { Action, ActionCategory } from '@digitranslab/view'
  ...
  import { WorkbenchEvents } from '@digitranslab/workbench'
