...
<script lang="ts">
  ...
  import notification, { DocNotifyContext, InboxNotification, notificationId } from '@digitranslab/notification'
  import { BrowserNotificatator, InboxNotificationsClientImpl } from '@digitranslab/notification-resources'
  import { broadcastEvent, getMetadata, getResource, IntlString, translate } from '@digitranslab/platform'
  import {
    ActionContext,
    ComponentExtensions,
    createQuery,
  ...
  import support, { supportLink, SupportStatus } from '@digitranslab/support'
  import {
    AnyComponent,
    areLocationsEqual,
    Button,
  ...
  >
    ...
    >
      ...
      <div
        ...
        class={navigatorModel === undefined ? 'emberPanels-container' : 'emberComponent overflow-hidden'}
