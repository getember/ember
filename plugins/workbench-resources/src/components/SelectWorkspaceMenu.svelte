...
<script lang="ts">
  ...
  import { isArchivingMode } from '@digitranslab/core'
  import login, { Workspace } from '@digitranslab/login'
  import { getMetadata, getResource } from '@digitranslab/platform'
  import presentation, { decodeTokenPayload, isAdminUser } from '@digitranslab/presentation'
  import {
    Icon,
    IconCheck,
    Label,
