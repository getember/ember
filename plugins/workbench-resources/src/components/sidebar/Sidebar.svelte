...
-->
<script lang="ts">
  import { addTxListener, createQuery, getClient, removeTxListener } from '@digitranslab/presentation'
  import { WidgetPreference, SidebarEvent, TxSidebarEvent, OpenSidebarWidgetParams } from '@digitranslab/workbench'
  import { Tx } from '@digitranslab/core'
  import { onMount } from 'svelte'
  import { panelstore, deviceOptionsStore as deviceInfo } from '@digitranslab/ui'
