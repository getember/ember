<script lang="ts">
  import core, { RateLimiter, concatLink, metricsAggregate, type Metrics } from '@digitranslab/core'
  import login from '@digitranslab/login'
  import { getEmbeddedLabel, getMetadata } from '@digitranslab/platform'
  import presentation, { getClient, isAdminUser, uiContext } from '@digitranslab/presentation'
  import { Button, IconArrowLeft, IconArrowRight, fetchMetadataLocalStorage, ticker } from '@digitranslab/ui'
  import EditBox from '@digitranslab/ui/src/components/EditBox.svelte'
