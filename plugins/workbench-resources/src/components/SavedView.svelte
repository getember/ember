<script lang="ts">
  ...
  import { Ref, getCurrentAccount, toIdMap } from '@digitranslab/core'
  ...
  import view, { Filter, FilteredView, ViewOptions, Viewlet } from '@digitranslab/view'
  import {
    EditBoxPopup,
    TreeItem,
    TreeNode,
  ...
  import { Application } from '@digitranslab/workbench'
