<script lang="ts">
  ...
  import presentation, { type OverviewStatistics } from '@digitranslab/presentation'
  import { Button, DropdownLabels, Expandable, IconArrowRight, ticker } from '@digitranslab/ui'
  import MetricsStats from './MetricsStats.svelte'
  import type { MetricsData } from '@digitranslab/core'
