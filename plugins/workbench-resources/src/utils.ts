...
import type { Account, Class, Client, Doc, Ref, Space, TxOperations } from '@digitranslab/core'
import core, { hasAccountRole } from '@digitranslab/core'
import type { Workspace } from '@digitranslab/login'
import login, { loginId } from '@digitranslab/login'
import { getResource, setMetadata } from '@digitranslab/platform'
import { closeClient, getClient } from '@digitranslab/presentation'
import presentation from '@digitranslab/presentation/src/plugin'
import {
  closePanel,
...
import workbench, { type Application, type NavigatorModel } from '@digitranslab/workbench'
