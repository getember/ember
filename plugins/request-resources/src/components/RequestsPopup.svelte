...
<script lang="ts">
  ...
  import { Class, getCurrentAccount, Ref } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Request, RequestStatus } from '@digitranslab/request'
  import { Label, Scroller, deviceOptionsStore as deviceInfo, AnyComponent, Component } from '@digitranslab/ui'
