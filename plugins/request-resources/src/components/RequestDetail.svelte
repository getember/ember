...
<script lang="ts">
  ...
  import { personAccountByIdStore, PersonRefPresenter } from '@digitranslab/contact-resources'
  import { Ref } from '@digitranslab/core'
  import { createQuery, MessageViewer } from '@digitranslab/presentation'
  import { Request, RequestDecisionComment } from '@digitranslab/request'
  import { BooleanIcon, Label, ShowMore } from '@digitranslab/ui'
