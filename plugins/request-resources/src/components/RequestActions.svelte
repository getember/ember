...
<script lang="ts">
  ...
  import { AttachedData, getCurrentAccount, Markup, Ref } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Request, RequestStatus } from '@digitranslab/request'
  import { EmptyMarkup, isEmptyMarkup } from '@digitranslab/text'
  import { type RefAction } from '@digitranslab/text-editor'
  import { Button } from '@digitranslab/ui'
