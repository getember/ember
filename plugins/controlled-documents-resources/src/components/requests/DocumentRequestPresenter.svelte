...
<script lang="ts">
  ...
  import { Button, Label, ProgressCircle, eventToHTMLElement, showPopup } from '@digitranslab/ui'
  ...
  import { RequestStatusPresenter, RequestDetailPopup } from '@digitranslab/request-resources'
