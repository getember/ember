...
<script lang="ts">
  ...
  import { Account, TypedSpace, type Data, type Ref, getCurrentAccount, type Permission } from '@digitranslab/core'
  import contact, { PersonAccount, type Employee } from '@digitranslab/contact'
  import documents, { type ControlledDocument } from '@digitranslab/controlled-documents'
  import { UserBoxItems } from '@digitranslab/contact-resources'
  import { type PermissionsStore, permissionsStore } from '@digitranslab/view-resources'
