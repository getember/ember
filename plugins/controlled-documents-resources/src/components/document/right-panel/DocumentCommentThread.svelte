...
-->
<script lang="ts">
  import documents, { DocumentComment } from '@digitranslab/controlled-documents'
  import { ThreadView } from '@digitranslab/chunter-resources'
  import { Button, IconCheckCircle, Label } from '@digitranslab/ui'
  import {
