...
<script lang="ts">
  import documents, { type Document, type DocumentTemplate } from '@digitranslab/controlled-documents'
  import { PersonPresenter } from '@digitranslab/contact-resources'
  import { DateRangeMode } from '@digitranslab/core'
  import { DatePresenter, Label, Scroller, eventToHTMLElement, showPopup } from '@digitranslab/ui'
