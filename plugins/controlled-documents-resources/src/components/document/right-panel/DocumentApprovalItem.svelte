<script lang="ts">
  ...
  import documents, { DocumentRequest } from '@digitranslab/controlled-documents'
  import chunter from '@digitranslab/chunter'
  import { type Person } from '@digitranslab/contact'
  import { PersonRefPresenter, personAccountByIdStore } from '@digitranslab/contact-resources'
  import { Ref } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Chevron, Label, tooltip } from '@digitranslab/ui'
