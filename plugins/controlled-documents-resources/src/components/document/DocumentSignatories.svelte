...
-->
<script lang="ts">
  import { Ref, SortingOrder } from '@digitranslab/core'
  import { Label, Scroller } from '@digitranslab/ui'
  import { createQuery } from '@digitranslab/presentation'
  import documents, { DocumentApprovalRequest, DocumentReviewRequest } from '@digitranslab/controlled-documents'
  import { employeeByIdStore } from '@digitranslab/contact-resources'
  import { Employee, Person, formatName } from '@digitranslab/contact'
