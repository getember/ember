<script lang="ts">
  ...
  import { makeDocCollabId, type Doc } from '@digitranslab/core'
  import { CollaborationIds, type Ydoc } from '@digitranslab/text-editor'
  import {
  ...
  import { Dropdown, Label, ListItem, Loading, Scroller, themeStore } from '@digitranslab/ui'
  import documents, {
    ControlledDocument,
