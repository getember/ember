<!--
// Copyright © 2023-2024 Digitrans Inc.
//
...
<script lang="ts">
  ...
  import { type Ref, type Blob, generateId } from '@digitranslab/core'
  ...
  import { Editor, Heading } from '@digitranslab/text-editor'
  import {
    CollaboratorEditor,
    TableOfContents,
  ...
  import { navigate, EditBox, Scroller } from '@digitranslab/ui'
  import { getCollaborationUser, getObjectLinkFragment } from '@digitranslab/view-resources'
