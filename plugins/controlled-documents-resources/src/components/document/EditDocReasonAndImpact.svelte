...
<script lang="ts">
  ...
  import { Label, Scroller, PlainTextEditor } from '@digitranslab/ui'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import documents, { type DocumentSpace, type ChangeControl, DocumentState } from '@digitranslab/controlled-documents'
