...
<script lang="ts">
  ...
  import { EmployeeBox, EmployeePresenter, personAccountByIdStore } from '@digitranslab/contact-resources'
  import core, { Ref, Space } from '@digitranslab/core'
  import presentation, { createQuery, getClient } from '@digitranslab/presentation'
  import { Button, Icon, Label } from '@digitranslab/ui'
