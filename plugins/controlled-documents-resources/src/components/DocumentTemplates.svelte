...
-->
<script lang="ts">
  import { Mixin, DocumentQuery, Ref } from '@digitranslab/core'
  import { DocumentSpace, type DocumentTemplate } from '@digitranslab/controlled-documents'
  import { ActionContext, createQuery } from '@digitranslab/presentation'
  import { Button, IconAdd, Loading, showPopup } from '@digitranslab/ui'
  import view, { ViewOptions, Viewlet, ViewletPreference } from '@digitranslab/view'
  import { TableBrowser, ViewletPanelHeader, checkMyPermission, permissionsStore } from '@digitranslab/view-resources'
