...
<script lang="ts">
  ...
  import { type Ref, type Doc, SortingOrder, getCurrentAccount, WithLookup } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import type { PersonAccount } from '@digitranslab/contact'
  import { type Action } from '@digitranslab/ui'
  import documents, {
  ...
  import { TreeItem } from '@digitranslab/view-resources'
