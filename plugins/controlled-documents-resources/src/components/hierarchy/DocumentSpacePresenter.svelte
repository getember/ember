...
-->
<script lang="ts">
  import { WithLookup, type Doc, type Ref, type Space } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { getResource } from '@digitranslab/platform'
  import { type Action, getPlatformColorForTextDef, themeStore, navigate, IconEdit, Label } from '@digitranslab/ui'
  import { getActions as getContributedActions, TreeNode, TreeItem } from '@digitranslab/view-resources'
  import { ActionGroup } from '@digitranslab/view'
  import {
