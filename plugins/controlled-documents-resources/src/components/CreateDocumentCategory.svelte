...
<script lang="ts">
  ...
  import { generateId, Ref, Space } from '@digitranslab/core'
  import { Card, getClient } from '@digitranslab/presentation'
  import { Button, EditBox, IconAttachment, tooltip } from '@digitranslab/ui'
  import { DocumentCategory } from '@digitranslab/controlled-documents'
