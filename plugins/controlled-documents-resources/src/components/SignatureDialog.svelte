...
<script lang="ts">
  ...
  import { ERROR, IntlString, OK, Severity, Status, getMetadata, translate } from '@digitranslab/platform'
  import { EditBox, StylishEdit, ModernDialog, fetchMetadataLocalStorage } from '@digitranslab/ui'
