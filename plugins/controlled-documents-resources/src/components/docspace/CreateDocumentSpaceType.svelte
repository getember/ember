...
<script lang="ts">
  ...
  import { Data, SpaceTypeDescriptor, generateId } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import documents, { DocumentSpaceType, DocumentSpaceTypeDescriptor } from '@digitranslab/controlled-documents'
  import { createSpaceType } from '@digitranslab/setting'
