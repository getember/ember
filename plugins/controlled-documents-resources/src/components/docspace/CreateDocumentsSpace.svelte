...
<script lang="ts">
  ...
  import presentation, { Card, getClient } from '@digitranslab/presentation'
  import { StyledTextBox } from '@digitranslab/text-editor-resources'
  import { EditBox, Label, Toggle } from '@digitranslab/ui'
  import { SpaceTypeSelector } from '@digitranslab/view-resources'
  import documents, { DocumentSpace, DocumentSpaceType } from '@digitranslab/controlled-documents'
