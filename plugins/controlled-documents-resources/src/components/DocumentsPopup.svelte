...
<script lang="ts">
  ...
  import type { Class, Doc, DocumentQuery, FindOptions, Ref } from '@digitranslab/core'
  import type { Asset, IntlString } from '@digitranslab/platform'
  import presentation, { getClient, ObjectCreate, ObjectPopup } from '@digitranslab/presentation'
  import { AnySvelteComponent, Label } from '@digitranslab/ui'
  import { ObjectPresenter } from '@digitranslab/view-resources'
  import documents, { type Document } from '@digitranslab/controlled-documents'
