...
<script lang="ts">
  ...
  import { AttachedData, Class, generateId, getCurrentAccount, Mixin, Ref, SortingOrder } from '@digitranslab/core'
  import { Card, createQuery, getClient } from '@digitranslab/presentation'
  import { createFocusManager, EditBox, FocusHandler } from '@digitranslab/ui'
