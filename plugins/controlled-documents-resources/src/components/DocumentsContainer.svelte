...
<script lang="ts">
  ...
  import { Class, DocumentQuery, Ref, Space } from '@digitranslab/core'
  import type { IntlString, Asset } from '@digitranslab/platform'
  import { IModeSelector, resolvedLocationStore } from '@digitranslab/ui'
  import documents, { type Document, type DocumentSpace, DocumentState } from '@digitranslab/controlled-documents'
