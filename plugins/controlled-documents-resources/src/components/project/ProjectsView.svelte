...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, Ref, WithLookup } from '@digitranslab/core'
  import { IntlString, translate } from '@digitranslab/platform'
  import { themeStore } from '@digitranslab/ui'
  import { Viewlet, ViewOptions } from '@digitranslab/view'
  import { FilterBar, SpaceHeader, ViewletContentView, ViewletSettingButton } from '@digitranslab/view-resources'
  import { Project, DocumentSpace } from '@digitranslab/controlled-documents'
