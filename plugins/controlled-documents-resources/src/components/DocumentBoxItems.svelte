...
<script lang="ts">
  ...
  import type { Class, DocumentQuery, Ref } from '@digitranslab/core'
  import type { IntlString } from '@digitranslab/platform'
  import { Label, showPopup, ActionIcon, IconClose, IconAdd, Icon } from '@digitranslab/ui'
  import type { IconSize } from '@digitranslab/ui'
