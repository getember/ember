...
-->
<script lang="ts">
  import { type Class, type Ref, SortingOrder } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Loading } from '@digitranslab/ui'
  import documents, { type ControlledDocument, type Project } from '@digitranslab/controlled-documents'
