...
import { type Client, type Doc, type Ref, type Space } from '@digitranslab/core'
import { type IntlString, mergeIds, type Resource } from '@digitranslab/platform'
import { type AnyComponent, type Location } from '@digitranslab/ui'
import type { KeyFilter, SortFunc, ViewActionAvailabilityFunction } from '@digitranslab/view'
