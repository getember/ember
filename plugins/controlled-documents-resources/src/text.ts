...
import { generateId, getCurrentAccount, type Ref } from '@digitranslab/core'
...
import { type ActionContext } from '@digitranslab/text-editor'
import { getNodeElement, selectNode, nodeUuidName } from '@digitranslab/text-editor-resources'
