...
import type { Asset, Metadata, Plugin, Resource } from '@digitranslab/platform'
import { IntlString, plugin } from '@digitranslab/platform'
import { TemplateField, TemplateFieldCategory } from '@digitranslab/templates'
import type { AnyComponent, ColorDefinition, ResolvedLocation, Location, ComponentExtensionId } from '@digitranslab/ui'
import { Action, FilterMode, Viewlet } from '@digitranslab/view'
