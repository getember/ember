...
-->
<script lang="ts">
  import { Doc, Ref, SortingOrder, Space } from '@digitranslab/core'
  import { Drive, Folder } from '@digitranslab/drive'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Action, navigate, IconEdit } from '@digitranslab/ui'
  import { TreeNode, TreeItem, getActions as getContributedActions } from '@digitranslab/view-resources'
