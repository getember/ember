...
-->
<script lang="ts">
  import { type Doc, type DocumentQuery, type Space, type Ref, type WithLookup } from '@digitranslab/core'
  import drive, { type Drive, type Folder } from '@digitranslab/drive'
  import { Scroller, SearchInput, Panel, Button, IconMoreH } from '@digitranslab/ui'
  import view, { Viewlet, ViewOptions } from '@digitranslab/view'
  import {
    FilterBar,
    FilterButton,
    ViewletContentView,
