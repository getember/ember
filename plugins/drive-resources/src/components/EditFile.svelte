...
-->
<script lang="ts">
  import { type Blob, type Ref, type WithLookup } from '@digitranslab/core'
  import drive, { type File, type FileVersion } from '@digitranslab/drive'
  import { FilePreview, createQuery } from '@digitranslab/presentation'
