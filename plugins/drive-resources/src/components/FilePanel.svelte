...
-->
<script lang="ts">
  import { type Ref, type WithLookup } from '@digitranslab/core'
  import { createFileVersion, type File as DriveFile, type FileVersion } from '@digitranslab/drive'
  import { Panel } from '@digitranslab/panel'
  import { createQuery, getClient, getFileUrl } from '@digitranslab/presentation'
  import { Button, IconMoreH } from '@digitranslab/ui'
  import { FileUploadCallbackParams, showFilesUploadPopup } from '@digitranslab/uploader'
