...
<script lang="ts">
  ...
  import { type Drive, type Folder, createFolder, DriveEvents } from '@digitranslab/drive'
  import { Card, SpaceSelector, getClient } from '@digitranslab/presentation'
  import { EditBox, FocusHandler, createFocusManager } from '@digitranslab/ui'
