...
-->
<script lang="ts">
  import type { Class, Doc, DocumentQuery, FindOptions, Ref, WithLookup } from '@digitranslab/core'
  import { type Resource } from '@digitranslab/drive'
  import { ActionContext, createQuery, getClient } from '@digitranslab/presentation'
  import { BuildModelKey, ViewOptions } from '@digitranslab/view'
  import { ListSelectionProvider, SelectDirection, buildConfigLookup, focusStore } from '@digitranslab/view-resources'
