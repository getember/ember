...
import { type Class, type Doc, type Ref, type Space, toIdMap } from '@digitranslab/core'
import drive, {
  type Drive,
  type FileVersion,
  type Folder,
...
import { type Asset, setPlatformStatus, unknownError } from '@digitranslab/platform'
import { getClient } from '@digitranslab/presentation'
import { type AnySvelteComponent, showPopup } from '@digitranslab/ui'
import {
  type FileUploadCallback,
  getDataTransferFiles,
  showFilesUploadPopup,
  uploadFiles
} from '@digitranslab/uploader'
