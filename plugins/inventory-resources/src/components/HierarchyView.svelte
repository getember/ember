...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Ref, SortingOrder } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Label, Loading } from '@digitranslab/ui'
  import { buildModel } from '@digitranslab/view-resources'
  import { Category } from '@digitranslab/inventory'
  import HierarchyElement from './HierarchyElement.svelte'
  import { buildConfigLookup } from '@digitranslab/view-resources/src/utils'
