...
-->
<script lang="ts">
  import core, { DocumentQuery } from '@digitranslab/core'
  import { Button, Breadcrumb, Scroller, SearchInput, showPopup, IconAdd, Header } from '@digitranslab/ui'
  import type { Category } from '@digitranslab/inventory'
