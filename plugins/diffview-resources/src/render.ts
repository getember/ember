...
import { type DiffHunk, type DiffLine, DiffLineType, EmptyLine } from '@digitranslab/diffview'
import { type HighlightOptions, highlightLines } from '@digitranslab/highlight'
