...
import { type LoginInfo } from '@digitranslab/login'
import {
  getWorkspaces,
  navigateToWorkspace,
  selectWorkspace,
  type Pages as LoginPages
} from '@digitranslab/login-resources'
import { getMetadata } from '@digitranslab/platform'
import presentation from '@digitranslab/presentation'
import { type Location, getCurrentLocation, locationToUrl, navigate } from '@digitranslab/ui'
