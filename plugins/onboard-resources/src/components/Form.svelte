...
-->
<script lang="ts">
  import { reduceCalls } from '@digitranslab/core'
  import { type IntlString, OK, Severity, Status, translate } from '@digitranslab/platform'
  import { Button, Label, StylishEdit, deviceOptionsStore as deviceInfo, themeStore } from '@digitranslab/ui'
