...
-->
<script lang="ts">
  import { Calendar, Event, ReccuringEvent, RecurringRule, Visibility, generateEventId } from '@digitranslab/calendar'
  import { Person, PersonAccount } from '@digitranslab/contact'
  import core, { Class, Doc, Markup, Ref, Space, generateId, getCurrentAccount } from '@digitranslab/core'
  import presentation, {
    createQuery,
