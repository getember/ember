...
<script lang="ts">
  ...
  import { DateRangeMode, Doc } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { DatePresenter, DateTimeRangePresenter, Label, showPopup } from '@digitranslab/ui'
  import view, { ObjectEditor } from '@digitranslab/view'
  import calendar from '../plugin'
  import DateRangePresenter from '@digitranslab/ui/src/components/calendar/DateRangePresenter.svelte'
