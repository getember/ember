...
<script lang="ts">
  ...
  import { CreateGuest, personAccountByIdStore } from '@digitranslab/contact-resources'
  import { IdMap, Ref } from '@digitranslab/core'
  ...
  import { themeStore } from '@digitranslab/theme'
  import { Button, IconAdd, closePopup, registerFocus, resizeObserver, showPopup } from '@digitranslab/ui'
