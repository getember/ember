...
-->
<script lang="ts">
  import { Event, ReccuringEvent, ReccuringInstance, RecurringRule } from '@digitranslab/calendar'
  import { Person } from '@digitranslab/contact'
  import { DocumentUpdate, Ref } from '@digitranslab/core'
  import presentation, { ComponentExtensions, getClient } from '@digitranslab/presentation'
