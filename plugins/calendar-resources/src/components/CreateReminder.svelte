...
<script lang="ts">
  ...
  import { UserBoxList } from '@digitranslab/contact-resources'
  import { Class, DateRangeMode, Doc, Ref, getCurrentAccount } from '@digitranslab/core'
  import { Card, getClient } from '@digitranslab/presentation'
  import ui, { DateRangePresenter, EditBox } from '@digitranslab/ui'
