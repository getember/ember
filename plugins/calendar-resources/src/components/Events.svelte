...
<script lang="ts">
  ...
  import { Class, DocumentQuery, Ref, Space, WithLookup } from '@digitranslab/core'
  ...
  import { ViewletSelector, getViewOptions, viewOptionStore } from '@digitranslab/view-resources'
  import calendar from '../plugin'
  // import { deviceOptionsStore as deviceInfo } from '@digitranslab/ui'
