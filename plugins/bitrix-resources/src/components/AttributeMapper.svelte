<script lang="ts">
  import { BitrixEntityMapping, BitrixFieldMapping, MappingOperation, Fields } from '@digitranslab/bitrix'
  import core, { AnyAttribute } from '@digitranslab/core'
  import { getEmbeddedLabel } from '@digitranslab/platform'
  import { getClient } from '@digitranslab/presentation'
  import { Button, eventToHTMLElement, IconDelete, Menu, showPopup, Action, IconEdit } from '@digitranslab/ui'
