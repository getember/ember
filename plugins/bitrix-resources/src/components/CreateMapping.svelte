<script lang="ts">
  import { BitrixEntityMapping, BitrixEntityType, mappingTypes } from '@digitranslab/bitrix'
  import core, { Class, ClassifierKind, Doc, Obj, Ref } from '@digitranslab/core'
  import { Card, createQuery, getClient } from '@digitranslab/presentation'
  import setting, { Integration } from '@digitranslab/setting'
  import { DropdownLabels } from '@digitranslab/ui'
