<script lang="ts">
  ...
  import core, { Class, Doc, generateId, Ref, Space, WithLookup } from '@digitranslab/core'
  import { getEmbeddedLabel, getMetadata } from '@digitranslab/platform'
  import presentation, { getClient, SpaceSelect } from '@digitranslab/presentation'
  import {
    Button,
    CheckBox,
    Expandable,
  ...
  import { NumberEditor } from '@digitranslab/view-resources'
