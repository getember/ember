<script lang="ts">
  ...
  import { AnyAttribute } from '@digitranslab/core'
  import { getEmbeddedLabel } from '@digitranslab/platform'
  import { getClient } from '@digitranslab/presentation'

  import contact, { ChannelProvider } from '@digitranslab/contact'
  import { Button, DropdownLabels, DropdownLabelsIntl, EditBox, IconAdd, IconDelete } from '@digitranslab/ui'
