<script lang="ts">
  import {
    ...
    MappingOperation,
    getAllAttributes
  } from '@digitranslab/bitrix'
  import { AnyAttribute, Status } from '@digitranslab/core'
  import { getEmbeddedLabel } from '@digitranslab/platform'
  import { getClient } from '@digitranslab/presentation'
  import InlineAttributeBarEditor from '@digitranslab/presentation/src/components/InlineAttributeBarEditor.svelte'
  import recruit from '@digitranslab/recruit'
  import task from '@digitranslab/task'
  import { Button, DropdownLabels, DropdownLabelsIntl, DropdownTextItem, IconAdd } from '@digitranslab/ui'
