<script lang="ts">
  import { BitrixEntityMapping, BitrixFieldMapping, MappingOperation } from '@digitranslab/bitrix'
  import { AnyAttribute } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { Button, Icon, IconArrowLeft, IconClose, Label } from '@digitranslab/ui'
