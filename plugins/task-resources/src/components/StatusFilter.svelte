...
-->
<script lang="ts">
  import core, { Doc, FindResult, IdMap, Ref, RefTo, Space, Status, toIdMap } from '@digitranslab/core'
  ...
  import { buildConfigLookup, getPresenter } from '@digitranslab/view-resources/src/utils'
