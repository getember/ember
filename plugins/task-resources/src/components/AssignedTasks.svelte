...
<script lang="ts">
  ...
  import { Class, Doc, DocumentQuery, getCurrentAccount, Ref, Status } from '@digitranslab/core'
  import { IntlString, Asset } from '@digitranslab/platform'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import tags, { TagCategory, TagElement } from '@digitranslab/tags'
  ...
  import { Viewlet, ViewletPreference, ViewOptions } from '@digitranslab/view'
  import {
    FilterBar,
    FilterButton,
    statusStore,
