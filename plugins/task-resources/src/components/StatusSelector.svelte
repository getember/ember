<script lang="ts">
  ...
  import { Class, IdMap, Ref, Status } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { DocPopup, getClient } from '@digitranslab/presentation'
  import { Task, TaskType } from '@digitranslab/task'
  import { getObjectId, ObjectPresenter, statusStore } from '@digitranslab/view-resources'
