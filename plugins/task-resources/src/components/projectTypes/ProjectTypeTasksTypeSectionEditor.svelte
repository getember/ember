...
<script lang="ts">
  ...
  import { ButtonIcon, IconAdd, Label, getCurrentResolvedLocation, navigate } from '@digitranslab/ui'
  import { createQuery } from '@digitranslab/presentation'
  import { ProjectType, ProjectTypeDescriptor, TaskType } from '@digitranslab/task'
