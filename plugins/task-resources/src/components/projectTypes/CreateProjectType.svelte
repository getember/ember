...
<script lang="ts">
  import { SpaceTypeDescriptor, generateId } from '@digitranslab/core'
  import { getClient } from '@digitranslab/presentation'
  import { ProjectTypeDescriptor, createProjectType } from '@digitranslab/task'
  import { ToggleWithLabel } from '@digitranslab/ui'
