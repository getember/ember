...
-->
<script lang="ts">
  import core, { Attribute, Class, Ref, Status, StatusCategory } from '@digitranslab/core'
  import { Asset, getEmbeddedLabel } from '@digitranslab/platform'
  import presentation, { createQuery, getClient } from '@digitranslab/presentation'
  import { clearSettingsStore, settingsStore } from '@digitranslab/setting-resources'
  import { ProjectType, TaskType, calculateStatuses, createState } from '@digitranslab/task'
  import {
    ButtonIcon,
    ButtonMenu,
    EmojiPopup,
  ...
  import { ColorsPopup, statusStore } from '@digitranslab/view-resources'
...
>
  ...
  <div class="emberModal-content__titleGroup">
  ...
  <div class="emberModal-content__settingsSet">
  ...
  <div class="emberModal-content__settingsSet table">
    <div class="emberTableAttr-container">
      <div class="emberTableAttr-header font-medium-12 withButton">
        <ButtonMenu
          {items}
          {selected}
          icon={IconSettings}
      ...
      <div class="emberTableAttr-content" class:mb-2={selected === 1}>
        {#if selected === 0}
          <ColorsPopup
