...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, mergeQueries, Ref, Space, WithLookup } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { createQuery } from '@digitranslab/presentation'
  import { Project, ProjectType, ProjectTypeDescriptor } from '@digitranslab/task'
  import { AnyComponent, Button, Component, IconAdd, Loading, SearchInput, showPopup, Header } from '@digitranslab/ui'
  import { Viewlet, ViewletDescriptor, ViewletPreference, ViewOptions } from '@digitranslab/view'
