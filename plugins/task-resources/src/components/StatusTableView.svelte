...
-->
<script lang="ts">
  import { Class, DocumentQuery, FindOptions, Ref, Status } from '@digitranslab/core'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Project, Task, getStates } from '@digitranslab/task'
  import type { TabItem } from '@digitranslab/ui'
  import { ScrollerBar, TabList, Switcher } from '@digitranslab/ui'
  import { TableBrowser, statusStore } from '@digitranslab/view-resources'
