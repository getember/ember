...
// Copyright © 2021, 2022, 2023, 2024 Digitrans Inc.
//
...
<script lang="ts">
  ...
  import task, { ProjectType, TaskType, calculateStatuses, findStatusAttr } from '@digitranslab/task'
  import { Ref, SortingOrder, Status } from '@digitranslab/core'
  ...
  import { IconPicker, statusStore } from '@digitranslab/view-resources'
  import { ClassAttributes, settingsStore } from '@digitranslab/setting-resources'
      ...
      <Scroller align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
        <div class="emberComponent-content gap">
          <div class="emberComponent-content__column-group mt-4">
            <div class="emberComponent-content__header mb-6">
