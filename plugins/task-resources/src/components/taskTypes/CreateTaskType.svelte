...
-->
<script lang="ts">
  import core, { Class, ClassifierKind, Data, Ref, RefTo, Status, generateId, toIdMap } from '@digitranslab/core'
  import { Resource, getEmbeddedLabel, getResource } from '@digitranslab/platform'
  import presentation, { getClient, hasResource } from '@digitranslab/presentation'
  import {
    ProjectType,
  ...
  import { DropdownIntlItem, Modal, ModernEditbox, Label, ButtonMenu } from '@digitranslab/ui'
  import task from '../../plugin'
  import TaskTypeKindEditor from './TaskTypeKindEditor.svelte'
  import { clearSettingsStore } from '@digitranslab/setting-resources'
