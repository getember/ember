...
-->
<script lang="ts">
  import contact, { Employee, Person, getName } from '@digitranslab/contact'
  import { Class, Doc, Ref, Space } from '@digitranslab/core'
  import { Task } from '@digitranslab/task'
  import { getClient } from '@digitranslab/presentation'
  import { UsersPopup, employeeByIdStore } from '@digitranslab/contact-resources'
  import { AttributeModel } from '@digitranslab/view'
  import { eventToHTMLElement, showPopup } from '@digitranslab/ui'
  import { getObjectPresenter } from '@digitranslab/view-resources'
  import { IntlString, getEmbeddedLabel } from '@digitranslab/platform'
