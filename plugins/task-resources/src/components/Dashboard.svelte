...
-->
<script lang="ts">
  import core, { Class, DocumentQuery, IdMap, Ref, Status, Timestamp } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import type { Project, Task } from '@digitranslab/task'
  import task, { getStates } from '@digitranslab/task'
  import { BarDashboard, DashboardItem } from '@digitranslab/ui'
