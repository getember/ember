...
import { type IntlString, type Resources } from '@digitranslab/platform'
...
import { getCurrentLocation, navigate, showPopup } from '@digitranslab/ui'
import { type ViewletDescriptor } from '@digitranslab/view'
import { CategoryQuery, groupBy, statusStore } from '@digitranslab/view-resources'
...
import { employeeByIdStore, personAccountByIdStore, personByIdStore } from '@digitranslab/contact-resources'
