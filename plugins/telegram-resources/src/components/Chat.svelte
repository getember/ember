...
<script lang="ts">
  ...
  import { AttachmentRefInput } from '@digitranslab/attachment-resources'
  import contact, { Channel, Contact, Person, PersonAccount, getName as getContactName } from '@digitranslab/contact'
  import { Avatar, personAccountByIdStore, personByIdStore } from '@digitranslab/contact-resources'
  import core, { IdMap, Ref, SortingOrder, generateId, getCurrentAccount } from '@digitranslab/core'
  import { InboxNotificationsClientImpl } from '@digitranslab/notification-resources'
  import { getEmbeddedLabel, getResource } from '@digitranslab/platform'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import setting, { Integration } from '@digitranslab/setting'
  import type { NewTelegramMessage, SharedTelegramMessage, TelegramMessage } from '@digitranslab/telegram'
