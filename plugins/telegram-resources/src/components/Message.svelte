...
<script lang="ts">
  ...
  import { AttachmentList } from '@digitranslab/attachment-resources'
  ...
  import type { SharedTelegramMessage } from '@digitranslab/telegram'
  import { CheckBox, getPlatformColorForText, themeStore } from '@digitranslab/ui'
