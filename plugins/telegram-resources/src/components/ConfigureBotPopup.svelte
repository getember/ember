...
<script lang="ts">
  import { CodeForm, Icon, IconCheckmark, Label, Loading, Modal, ModernButton } from '@digitranslab/ui'
  import presentation from '@digitranslab/presentation'
  import { getEmbeddedLabel, getMetadata, IntlString } from '@digitranslab/platform'
  import { concatLink, getCurrentAccount } from '@digitranslab/core'
...
<Modal
  ...
  on:close
>
  <div class="emberModal-content__titleGroup" style="padding: 0">
    {#if isLoading}
