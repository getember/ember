...
import type { Attribute, Class, Doc, Mixin, Ref, Status } from '@digitranslab/core'
import type { Asset, IntlString, Plugin, Resource } from '@digitranslab/platform'
import { plugin } from '@digitranslab/platform'
import type { ProjectTypeDescriptor, TaskType } from '@digitranslab/task'
import { AnyComponent, Location, ResolvedLocation } from '@digitranslab/ui'
