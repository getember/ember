...
import contact, { Channel, PersonAccount, Organization } from '@digitranslab/contact'
import core, {
  AnyAttribute,
  AttachedDoc,
  Class,
...
import { Message } from '@digitranslab/gmail'
import recruit, { Applicant, Candidate, Vacancy } from '@digitranslab/recruit'
import tags, { TagCategory, TagElement, TagReference } from '@digitranslab/tags'
