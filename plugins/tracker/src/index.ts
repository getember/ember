...
import { Employee, Person } from '@digitranslab/contact'
import {
  AttachedDoc,
  Attribute,
  Class,
...
import { Asset, IntlString, Plugin, Resource, plugin } from '@digitranslab/platform'
import { Preference } from '@digitranslab/preference'
import { TagCategory, TagElement, TagReference } from '@digitranslab/tags'
...
import { AnyComponent, ComponentExtensionId, Location, ResolvedLocation } from '@digitranslab/ui'
import { Action, ActionCategory, IconProps } from '@digitranslab/view'
