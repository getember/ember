...
-->
<script lang="ts">
  import { Class, Doc, Ref, SortingOrder } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import { TagCategory, TagElement } from '@digitranslab/tags'
  import { ModernButton, getPlatformColorForTextDef, showPopup, themeStore, ScrollerBar } from '@digitranslab/ui'
