<script lang="ts">
  import { Doc, WithLookup } from '@digitranslab/core'
  import { createQuery } from '@digitranslab/presentation'
  import type { TagReference } from '@digitranslab/tags'
  import tags from '@digitranslab/tags'
  import { Chip, getEventPopupPositionElement, resizeObserver, showPopup, tooltip } from '@digitranslab/ui'
