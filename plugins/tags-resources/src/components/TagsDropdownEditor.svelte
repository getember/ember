...
-->
<script lang="ts">
  import type { AttachedDoc, Class, Collection, Doc, Ref } from '@digitranslab/core'
  import { IntlString, translateCB } from '@digitranslab/platform'
  import { KeyedAttribute } from '@digitranslab/presentation'
  import { TagElement, TagReference } from '@digitranslab/tags'
  import type { ButtonKind, ButtonSize, TooltipAlignment } from '@digitranslab/ui'
  import { Button, showPopup, themeStore } from '@digitranslab/ui'
