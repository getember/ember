...
-->
<script lang="ts">
  import core, { Data, DocumentUpdate } from '@digitranslab/core'
  ...
  import { DropdownTextItem } from '@digitranslab/ui/src/types'
  import { ColorsPopup } from '@digitranslab/view-resources'
