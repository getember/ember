<script lang="ts">
  import { AnyAttribute, Class, Doc, Ref } from '@digitranslab/core'
  import { IntlString } from '@digitranslab/platform'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import tags, { TagReference, TagsEvents } from '@digitranslab/tags'
  import { Icon, Label, getEventPopupPositionElement, showPopup } from '@digitranslab/ui'
