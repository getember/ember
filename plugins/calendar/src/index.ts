...
import type { AttachedDoc, Class, Doc, Markup, Mixin, Ref, SystemSpace, Timestamp } from '@digitranslab/core'
import { NotificationType } from '@digitranslab/notification'
import type { Asset, IntlString, Metadata, Plugin } from '@digitranslab/platform'
import { plugin } from '@digitranslab/platform'
import { Handler, IntegrationType } from '@digitranslab/setting'
import { AnyComponent, ComponentExtensionId } from '@digitranslab/ui'
