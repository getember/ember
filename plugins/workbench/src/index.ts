...
import type { AccountRole, Class, Doc, Mixin, Obj, Ref, Space, Tx } from '@digitranslab/core'
import { DocNotifyContext, InboxNotification } from '@digitranslab/notification'
import type { Asset, IntlString, Metadata, Plugin, Resource } from '@digitranslab/platform'
...
import { ViewAction } from '@digitranslab/view'
