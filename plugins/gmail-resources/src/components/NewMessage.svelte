...
<script lang="ts">
  ...
  import attachmentP, { Attachment } from '@digitranslab/attachment'
  import { AttachmentPresenter } from '@digitranslab/attachment-resources'
  import contact, { Channel, Contact, getName } from '@digitranslab/contact'
  import core, { Data, Markup, generateId } from '@digitranslab/core'
  import { NewMessage, SharedMessage, GmailEvents } from '@digitranslab/gmail'
  import { InboxNotificationsClientImpl } from '@digitranslab/notification-resources'
  import { getResource, setPlatformStatus, unknownError } from '@digitranslab/platform'
  import { createQuery, getClient } from '@digitranslab/presentation'
  import { Integration } from '@digitranslab/setting'
  import templates, { TemplateDataProvider } from '@digitranslab/templates'
  import { EmptyMarkup, isEmptyMarkup, markupToHTML } from '@digitranslab/text'
  import { StyledTextEditor } from '@digitranslab/text-editor-resources'
  import { Button, EditBox, IconArrowLeft, IconAttachment, Label, Scroller } from '@digitranslab/ui'
