...
<script lang="ts">
  ...
  import contact, { Channel, Contact, getName as getContactName } from '@digitranslab/contact'
  import core, { generateId, getCurrentAccount, Markup, Ref, toIdMap } from '@digitranslab/core'
  ...
  import { GmailEvents } from '@digitranslab/gmail'
