...
import { initStatisticsContext, type StorageConfiguration } from '@digitranslab/server-core'
import { join } from 'path'

import { createElasticAdapter } from '@digitranslab/elastic'
import { createRekoniAdapter, type FulltextDBConfiguration } from '@digitranslab/server-indexer'
