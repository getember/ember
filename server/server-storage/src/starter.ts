import { DatalakeService, type DatalakeConfig } from '@digitranslab/datalake'
import { MinioConfig, MinioService, addMinioFallback } from '@digitranslab/minio'
import { S3Service, type S3Config } from '@digitranslab/s3'
import { StorageAdapter, StorageConfiguration, type StorageConfig } from '@digitranslab/server-core'
