...
import { decodeToken as decodeTokenRaw, generateToken, type Token } from '@digitranslab/server-token'
import { connect } from '@digitranslab/server-tool'
import { randomBytes } from 'crypto'
import otpGenerator from 'otp-generator'

import { getWorkspaceDestroyAdapter } from '@digitranslab/server-pipeline'
...
async function generateWorkspaceRecord (
  ...
  const brandingKey = branding?.key ?? 'ember'
