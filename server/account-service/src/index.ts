...
import accountEn from '@digitranslab/account/lang/en.json'
import accountRu from '@digitranslab/account/lang/ru.json'
import { Analytics } from '@digitranslab/analytics'
import { registerProviders } from '@digitranslab/auth-providers'
import { metricsAggregate, type BrandingMap, type MeasureContext } from '@digitranslab/core'
import platform, { Severity, Status, addStringsLoader, setMetadata } from '@digitranslab/platform'
import serverToken, { decodeToken } from '@digitranslab/server-token'
