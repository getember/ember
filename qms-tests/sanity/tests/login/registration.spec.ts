...
test.describe('Registration tests', () => {
  ...
  test.skip('TESTS-143. User Registration', async ({ page }) => {
    ...
    await allure.tms('TESTS-143', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-143')
  ...
  test('TESTS-144. Negative - Duplicate Email', async ({ page }) => {
    ...
    await allure.tms('TESTS-144', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-144')
    const signUpUserData: UserSignUp = {
      firstName: randomString(),
      lastName: randomString(),
      email: 'user1',
  ...
  test('TESTS-396. Correct email and wrong password: I cannot log in ', async ({ page }) => {
    ...
    await allure.tms('TESTS-396', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-396')
  ...
  test('TESTS-397. Wrong email and correct password: I cannot log in ', async ({ page }) => {
    ...
    await allure.tms('TESTS-397', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-397')
  ...
  test('TESTS-398. Correct email and correct password: I can log in ', async ({ page }) => {
    ...
    await allure.tms('TESTS-398', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-397')
