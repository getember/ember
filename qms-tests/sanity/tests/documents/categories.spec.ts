...
test.describe('QMS. Categories tests', () => {
  ...
  test('TESTS-131. Create a new category', async ({ page }) => {
    ...
    await allure.tms('TESTS-131', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-131')
  ...
  test('TESTS-132. Edit a Category', async ({ page }) => {
    ...
    await allure.tms('TESTS-132', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-132')
  ...
  test('TESTS-133. Delete Category', async ({ page }) => {
    ...
    await allure.tms('TESTS-133', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-133')
    const editCategory: NewCategory = {
  ...
  test('TESTS-215. Can not Delete Category if there are templates associated', async ({ page }) => {
    ...
    await allure.tms('TESTS-215', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-215')
