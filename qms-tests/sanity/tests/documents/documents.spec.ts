...
test.describe('QMS. Documents tests', () => {
  ...
  test('TESTS-123. Create a document', async ({ page }) => {
    ...
    await allure.tms('TESTS-123', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-123')
  ...
  test('TESTS-124. Edit document', async ({ page }) => {
    ...
    await allure.tms('TESTS-124', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-124')
  ...
  test('TESTS-127. Delete Document', async ({ page }) => {
    ...
    await allure.tms('TESTS-127', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-127')
  ...
  test('TESTS-125. Create child document', async ({ page }) => {
    ...
    await allure.tms('TESTS-125', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-125')
  ...
  test('TESTS-126. Change document owner', async ({ page }) => {
    ...
    await allure.tms('TESTS-126', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-126')
  ...
  test('TESTS-134. Send for review document', async ({ page }) => {
    ...
    await allure.tms('TESTS-134', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-134')
  ...
  test('TESTS-135. Send for approval document', async ({ page }) => {
    ...
    await allure.tms('TESTS-135', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-135')
    const changeDocument: NewDocument = {
      template: 'HR (HR)',
  ...
  test('TESTS-136. Add and resolve Comments', async ({ page }) => {
    ...
    await allure.tms('TESTS-136', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-136')
  ...
  test('TESTS-137. Approve document', async ({ page }) => {
    ...
    await allure.tms('TESTS-137', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-137')
  ...
  test('TESTS-138. Reject document', async ({ page }) => {
    ...
    await allure.tms('TESTS-138', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-138')
  ...
  test('TESTS-139. Make Review', async ({ page }) => {
    ...
    await allure.tms('TESTS-139', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-139')
  ...
  test('TESTS-140. Comparing several document versions', async ({ page }) => {
    ...
    await allure.tms('TESTS-140', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-140')
    const makeReviewDocument: NewDocument = {
      template: 'HR (HR)',
  ...
  test('TESTS-162. Approve document with delayed release', async ({ page }) => {
    ...
    await allure.tms('TESTS-162', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-162')
  ...
  test('TESTS-161. Check elements in the popup with the new Comment', async ({ page }) => {
    ...
    await allure.tms('TESTS-161', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-161')
  ...
  test('TESTS-155. Change document owner. QARA user changes owner from one user to another', async ({
    ...
    await allure.tms('TESTS-155', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-155')
  ...
  test('TESTS-205. Test Reason & Impact sections', async ({ page, browser }) => {
    ...
    await allure.tms('TESTS-205', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-205')
  ...
  test('TESTS-206. Send for approval document after resolve comments', async ({ page, browser }) => {
    ...
    await allure.tms('TESTS-206', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-206')
  ...
  test('TESTS-352. Create a document', async ({ page }) => {
    ...
    await allure.description('Requirement\nUsers need to create a new document')
    await allure.tms('TESTS-352', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-352')
  ...
  test('TESTS-380. As a space QARA, I can select "Custom" field in "Reason" for creating this Quality doc and it is stored in the History of Version 2 of this doc', async ({
    ...
    await allure.description('Requirement\nUsers need to create a new document')
    await allure.tms('TESTS-380', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-380')
  ...
  test('TESTS-214. Check old existing document content', async ({ page, browser }) => {
    ...
    await allure.tms('TESTS-214', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-214')
