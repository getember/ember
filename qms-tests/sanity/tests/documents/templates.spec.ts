...
test.describe('QMS. Templates tests', () => {
  ...
  test('TESTS-129. Create Template', async ({ page }) => {
    ...
    await allure.tms('TESTS-129', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-129')
  ...
  test('TESTS-181. Delete template', async ({ page }) => {
    ...
    await allure.tms('TESTS-181', 'https://front.digitrans.lab/workbench/platform/tracker/TESTS-181')
