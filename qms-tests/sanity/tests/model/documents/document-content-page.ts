...
export class DocumentContentPage extends DocumentCommonPage {
  ...
  constructor (page: Page) {
    ...
    this.buttonMoreActions = page.locator('.emberHeader-buttonsGroup > .no-print > .antiButton').first()
    ...
    this.buttonSendForReview = page.locator('div.emberHeader-buttonsGroup.extra button[type="button"] > span', {
      hasText: 'Send for review'
    })
    this.buttonSendForApproval = page.locator('div.emberHeader-buttonsGroup.extra button[type="button"] > span', {
    ...
    this.buttonCurrentRights = page.locator(
      'div.emberHeader-buttonsGroup.extra button[type="button"] > span[slot="content"]'
    )
    ...
    this.buttonCompleteReview = page.locator('div.emberHeader-buttonsGroup.extra button[type="button"] > span', {
    ...
    this.buttonEditDocument = page.locator('div.emberHeader-buttonsGroup.extra button[type="button"] > span', {
      hasText: 'Edit document'
    })
    this.buttonDraftNewVersion = page.locator('div.emberHeader-buttonsGroup.extra button[type="button"] > span', {
    ...
    this.textPageHeader = page.locator('div.emberNavPanel-header')
