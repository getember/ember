...
export class SettingsPage {
  ...
  constructor (page: Page) {
    ...
    this.addPermissionButton = page.locator('.emberTableAttr-header > .font-medium-14')
    ...
    this.addUpdateDocumentOwnerPermission = page.locator('.emberTableAttr-header > .font-medium-14')
  }
