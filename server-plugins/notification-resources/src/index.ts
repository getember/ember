...
import serverNotification, {
  ...
  ReceiverInfo,
  SenderInfo
} from '@digitranslab/server-notification'
import serverView from '@digitranslab/server-view'
import { markupToText, stripTags } from '@digitranslab/text'
...
export async function getContentByTemplate (
  ...
  const app = control.branding?.title ?? 'Ember'
...
export async function createPushNotification (
  ...
  const subject = getMetadata(serverNotification.metadata.PushSubject) ?? 'mailto:hey@ember.io'
