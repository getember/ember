...
import contact, { formatName, PersonAccount, type Person, type PersonSpace } from '@digitranslab/contact'
import core, {
  Account,
  Class,
  concatLink,
...
import { getMetadata, getResource, IntlString, translate } from '@digitranslab/platform'
