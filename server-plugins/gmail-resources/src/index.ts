...
import contact, { Channel, formatName } from '@digitranslab/contact'
import {
  Account,
  Class,
  concatLink,
...
import gmail, { Message } from '@digitranslab/gmail'
import { TriggerControl } from '@digitranslab/server-core'
import { BaseNotificationType, InboxNotification, NotificationType } from '@digitranslab/notification'
import serverNotification, {
  NotificationProviderFunc,
  ReceiverInfo,
  SenderInfo
} from '@digitranslab/server-notification'
import { getContentByTemplate } from '@digitranslab/server-notification-resources'
