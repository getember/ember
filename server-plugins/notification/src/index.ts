...
// Copyright © 2021, 2022, 2023 Digitrans Inc.
//
...
import { ActivityMessage } from '@digitranslab/activity'
import contact, { Employee, Person, PersonAccount, PersonSpace } from '@digitranslab/contact'
import { Account, Class, Doc, Mixin, Ref, Tx, TxCUD } from '@digitranslab/core'
import {
...
import type { TriggerControl, TriggerFunc } from '@digitranslab/server-core'

/**
 * @public
 */
export const serverNotificationId = 'server-notification' as Plugin
export { DOMAIN_USER_NOTIFY, DOMAIN_NOTIFICATION, DOMAIN_DOC_NOTIFY } from '@digitranslab/notification'
