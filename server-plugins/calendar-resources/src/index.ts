...
import calendar, { Calendar, Event, ExternalCalendar } from '@digitranslab/calendar'
import contactPlugin, { Contact, Person, PersonAccount } from '@digitranslab/contact'
import core, {
  Class,
  Data,
  Doc,
...
import { getHTMLPresenter, getTextPresenter } from '@digitranslab/server-notification-resources'
