...
import type { CollaborativeDoc, Doc, Tx, TxRemoveDoc } from '@digitranslab/core'
import core, { makeCollabId } from '@digitranslab/core'
import { removeCollabYdoc } from '@digitranslab/collaboration'
