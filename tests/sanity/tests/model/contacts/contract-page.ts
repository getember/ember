...
export class ContractPage {
  ...
  readonly employeeNavElement = (Employee: string): Locator =>
    this.page.locator(`.emberNavItem-container:has-text("${Employee}")`)

  readonly employeeButton = (Employee: string): Locator =>
    this.page.locator(`button:not(.emberNavItem-container, .emberBreadcrumb-container):has-text("${Employee}")`)
  ...
  readonly comapnyTab = (): Locator => this.page.locator('.emberNavItem-container:has-text("Company")')
