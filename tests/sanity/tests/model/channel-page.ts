...
export class ChannelPage extends CommonPage {
  ...
  readonly textMessage = (messageText: string): Locator =>
    this.page.locator('.emberComponent .activityMessage', { hasText: messageText })
  ...
  readonly closeReplyButton = (): Locator => this.page.locator('.emberHeader-container > button.iconOnly')
  ...
  readonly inputSearchChannel = (): Locator => this.page.locator('.emberHeader-container').getByPlaceholder('Search')

  readonly channelContainers = (): Locator => this.page.locator('.emberNavItem-container')

  readonly starredChannelContainers = (): Locator =>
    this.page.locator('#navGroup-starred').locator('.emberNavItem-container')

  readonly issueChannelContainers = (): Locator =>
    this.page.locator('#navGroup-tracker\\:class\\:Issue').locator('.emberNavItem-container')

  readonly vacancyChannelContainers = (): Locator =>
    this.page.locator('#navGroup-recruit\\:class\\:Vacancy').locator('.emberNavItem-container')

  readonly applicationChannelContainers = (): Locator =>
    this.page.locator('#navGroup-recruit\\:class\\:Applicant').locator('.emberNavItem-container')
  ...
  async makeActionWithChannelInMenu (channelName: string, action: string): Promise<void> {
    ...
    await this.channelContainers().filter({ hasText: channelName }).locator('.emberNavItem-actions').click()
