...
export class CommonTrackerPage extends CalendarPage {
  ...
  buttonMoreActions = (): Locator =>
    this.page.locator('.popupPanel > .emberHeader-container button[data-id="btnMoreActions"]')
  ...
  header = (): Locator =>
    this.page.locator('button.emberBreadcrumb-container > span.emberBreadcrumb-label', { hasText: 'Issues' })

  view = (): Locator => this.page.locator('.emberHeader-buttonsGroup > button[data-id="btn-viewOptions"]')
  showMore = (): Locator => this.page.locator('.emberHeader-buttonsGroup > button[data-id="btn-viewSetting"]')
  task1 = (): Locator => this.page.getByRole('link', { name: 'Welcome to Ember! 🌟' })
  ...
  task5 = (): Locator => this.page.getByRole('link', { name: 'Explore all Ember has to offer' })
