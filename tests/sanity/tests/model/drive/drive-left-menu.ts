...
export class DriveLeftMenu {
  ...
  readonly leftMenu = (): Locator => this.page.locator('.antiPanel-wrap__content.emberNavPanel-container')
  ...
  readonly buttonDriveInTree = (drive: Drive): Locator =>
    this.treeDrives().locator('.emberNavGroup-container').getByRole('button', { name: drive.name })

  readonly driveContainer = (drive: Drive): Locator =>
    this.treeDrives()
      .locator('.emberNavGroup-container')
      .filter({
