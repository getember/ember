...
export class ChunterPage {
  ...
  readonly buttonChannelBrowser = (): Locator => this.page.locator('.emberNavPanel-header > button.type-button-icon')
  ...
  readonly buttonNewDirectChatModalNext = (): Locator => this.page.locator('.emberModal-footer button:has-text("Next")')
  readonly buttonNewDirectChatModalCreate = (): Locator =>
    this.page.locator('.emberModal-footer button:has-text("Create")')

  readonly directMessagesButtonInLeftMenu = (): Locator =>
    this.page.locator('.emberNavGroup-header:has-text("Direct messages")')
