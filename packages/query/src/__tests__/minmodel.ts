...
import core, { AccountRole, AttachedDoc, ClassifierKind, DOMAIN_MODEL, DOMAIN_TX, TxFactory } from '@digitranslab/core'
import type { IntlString, Plugin } from '@digitranslab/platform'
