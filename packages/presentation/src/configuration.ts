...
import core, { SortingOrder, type PluginConfiguration, type TxUpdateDoc } from '@digitranslab/core'
import { getResourcePlugin, type Plugin, type Resource } from '@digitranslab/platform'
