...
-->
<script lang="ts">
  import { Class, DocumentQuery, FindOptions, Ref, Space } from '@digitranslab/core'
  import { Asset, IntlString } from '@digitranslab/platform'
  import { AnyComponent, AnySvelteComponent, ButtonKind, ButtonShape, ButtonSize } from '@digitranslab/ui'
