...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Ref, Space, getCurrentAccount } from '@digitranslab/core'
  import { Asset, getResource } from '@digitranslab/platform'
  import { AnyComponent, AnySvelteComponent, ButtonSize } from '@digitranslab/ui'
