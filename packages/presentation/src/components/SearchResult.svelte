...
-->
<script lang="ts">
  import type { SearchResultDoc } from '@digitranslab/core'
  import { getResourceC } from '@digitranslab/platform'
  import { Icon, type AnySvelteComponent } from '@digitranslab/ui'
