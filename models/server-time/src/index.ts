...
import core, { type Tx } from '@digitranslab/core'
import { TClass } from '@digitranslab/model-core'
...
import serverTime, { type ToDoFactory, type OnToDo } from '@digitranslab/server-time'
import time, { type ToDo, type WorkSlot } from '@digitranslab/time'
...
export * from '@digitranslab/server-time'
