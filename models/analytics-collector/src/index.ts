...
import { type Builder, Model, Prop, ReadOnly, TypeString, UX, TypeBoolean } from '@digitranslab/model'
import { type OnboardingChannel } from '@digitranslab/analytics-collector'
import chunter from '@digitranslab/chunter'
import { TChannel } from '@digitranslab/model-chunter'
import activity, { type ActivityMessageControl } from '@digitranslab/activity'
import core from '@digitranslab/core'

import analyticsCollector from './plugin'

export { analyticsCollectorId } from '@digitranslab/analytics-collector'
