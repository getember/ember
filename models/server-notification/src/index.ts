...
import { type Builder, Mixin, Model } from '@digitranslab/model'

import contact from '@digitranslab/contact'
import core, { type Ref } from '@digitranslab/core'
import { TClass, TDoc } from '@digitranslab/model-core'
import { TNotificationType } from '@digitranslab/model-notification'
import notification, { type NotificationProvider } from '@digitranslab/notification'
...
export { serverNotificationId } from '@digitranslab/server-notification'
