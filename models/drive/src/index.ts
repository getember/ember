...
import { TAttachedDoc, TCard, TType, TTypedSpace } from '@digitranslab/model-core'
...
import view, { type Viewlet, actionTemplates, classPresenter, createAction } from '@digitranslab/model-view'
import workbench from '@digitranslab/model-workbench'
import { getEmbeddedLabel } from '@digitranslab/platform'

import drive from './plugin'

export { driveId } from '@digitranslab/drive'
