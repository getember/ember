...
import core, { type Blob, type Ref, DOMAIN_BLOB, generateId, toIdMap } from '@digitranslab/core'
import type { Drive, File, FileVersion, Resource } from '@digitranslab/drive'
import {
