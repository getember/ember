...
import { type PersonSpace } from '@digitranslab/contact'
import {
  AccountRole,
  DOMAIN_MODEL,
  IndexKind,
...
import view, { createAction, template } from '@digitranslab/model-view'
...
export { notificationId, DOMAIN_USER_NOTIFY, DOMAIN_NOTIFICATION, DOMAIN_DOC_NOTIFY } from '@digitranslab/notification'
