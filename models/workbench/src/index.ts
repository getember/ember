...
import { type Class, DOMAIN_MODEL, type Ref, type Space, type AccountRole } from '@digitranslab/core'
import { type Builder, Mixin, Model, Prop, TypeRef, UX } from '@digitranslab/model'
import preference, { TPreference } from '@digitranslab/model-preference'
import { createAction } from '@digitranslab/model-view'
import { getEmbeddedLabel, type Asset, type IntlString, type Resource } from '@digitranslab/platform'
import view, { type KeyBinding } from '@digitranslab/view'
import type {
  Application,
  ApplicationNavModel,
  HiddenApplication,
