...
import { type Board, boardId } from '@digitranslab/board'
import board from '@digitranslab/board-resources/src/plugin'
import type { Ref } from '@digitranslab/core'
import { type IntlString, mergeIds } from '@digitranslab/platform'
import { type TaskTypeDescriptor, type ProjectType, type Sequence } from '@digitranslab/task'
import type { AnyComponent } from '@digitranslab/ui/src/types'
import { type Action, type ViewAction, type Viewlet, type ViewletDescriptor } from '@digitranslab/view'
