...
import core, { TDoc, TType } from '@digitranslab/model-core'
import preference, { TPreference } from '@digitranslab/model-preference'
import tags from '@digitranslab/model-tags'
import task, { actionTemplates as taskActionTemplates, TProject, TTask } from '@digitranslab/model-task'
import view, { actionTemplates, createAction, actionTemplates as viewTemplates } from '@digitranslab/model-view'
import workbench, { type Application } from '@digitranslab/model-workbench'
import { type IntlString } from '@digitranslab/platform'
import type { AnyComponent } from '@digitranslab/ui/src/types'
import board from './plugin'

export { boardId } from '@digitranslab/board'
