...
import core, { TAttachedDoc, TClass, TDoc } from '@digitranslab/model-core'
...
import { WidgetType } from '@digitranslab/workbench'

import calendar from './plugin'

export * from '@digitranslab/calendar'
export { calendarId } from '@digitranslab/calendar'
