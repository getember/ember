...
import type { Employee, Organization } from '@digitranslab/contact'
import {
  Account,
  IndexKind,
  type Collection,
...
import calendar, { TEvent } from '@digitranslab/model-calendar'
import chunter from '@digitranslab/model-chunter'
import contact, { TOrganization, TPerson } from '@digitranslab/model-contact'
import core, { TAttachedDoc } from '@digitranslab/model-core'
import tags from '@digitranslab/model-tags'
import task, { DOMAIN_TASK, TProject, TTask } from '@digitranslab/model-task'
...
import type {
  ...
  Vacancy,
  VacancyList
} from '@digitranslab/recruit'
import survey, { type Poll } from '@digitranslab/survey'
