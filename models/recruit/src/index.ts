...
import { AccountRole, SortingOrder, type Lookup, type Ref } from '@digitranslab/core'
import { type Builder } from '@digitranslab/model'
import attachment from '@digitranslab/model-attachment'
import calendar from '@digitranslab/model-calendar'
import chunter from '@digitranslab/model-chunter'
import contact from '@digitranslab/model-contact'
import core from '@digitranslab/model-core'
import gmail from '@digitranslab/model-gmail'
import { generateClassNotificationTypes } from '@digitranslab/model-notification'
import presentation from '@digitranslab/model-presentation'
import tags from '@digitranslab/model-tags'
import task, { actionTemplates } from '@digitranslab/model-task'
import tracker from '@digitranslab/model-tracker'
import view, { createAction, showColorsViewOption, actionTemplates as viewTemplates } from '@digitranslab/model-view'
import workbench, { createNavigateAction, type Application } from '@digitranslab/model-workbench'
import notification from '@digitranslab/notification'
import { type IntlString } from '@digitranslab/platform'
import { recruitId, type Applicant, RecruitEvents } from '@digitranslab/recruit'
import setting from '@digitranslab/setting'
import { type KeyBinding, type ViewOptionModel, type ViewOptionsModel } from '@digitranslab/view'
...
export { recruitId } from '@digitranslab/recruit'
