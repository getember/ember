...
import { type Channel } from '@digitranslab/contact'
import { type Class, type Domain, IndexKind, type Ref, type Timestamp, type Type } from '@digitranslab/core'
import type { Message, NewMessage, SharedMessage, SharedMessages } from '@digitranslab/gmail'
import {
  ArrOf,
  type Builder,
  Collection,
...
export { gmailId } from '@digitranslab/gmail'
