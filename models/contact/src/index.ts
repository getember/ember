...
import core, { TAccount, TAttachedDoc, TDoc, TSpace } from '@digitranslab/model-core'
...
import view, { createAction, createAttributePresenter, type Viewlet } from '@digitranslab/model-view'
import workbench from '@digitranslab/model-workbench'
import notification from '@digitranslab/notification'
import type { Asset, IntlString, Resource } from '@digitranslab/platform'
...
export { contactId } from '@digitranslab/contact'
