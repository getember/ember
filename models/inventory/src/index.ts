...
import { type Domain, IndexKind, type Ref } from '@digitranslab/core'
import { type Category, type Product, type Variant, inventoryId } from '@digitranslab/inventory'
import { type Builder, Collection, Index, Model, Prop, TypeRef, TypeString, UX } from '@digitranslab/model'
import attachment from '@digitranslab/model-attachment'
import core, { TAttachedDoc } from '@digitranslab/model-core'
import { createAction } from '@digitranslab/model-view'
import workbench from '@digitranslab/model-workbench'
import setting from '@digitranslab/setting'
import view, { type Viewlet } from '@digitranslab/view'
import chunter from '@digitranslab/model-chunter'
import activity from '@digitranslab/activity'

import inventory from './plugin'
export { inventoryId } from '@digitranslab/inventory'
