...
import { type Timestamp, type Domain, type Ref, type Tx } from '@digitranslab/core'
import {
  ArrOf,
  type Builder,
  Collection,
...
import core, { TAttachedDoc, TClass } from '@digitranslab/model-core'
