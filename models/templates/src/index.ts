...
import { type Domain, DOMAIN_MODEL, IndexKind, type Ref, type Markup, AccountRole } from '@digitranslab/core'
import { type Builder, Index, Model, Prop, TypeString, UX, TypeMarkup } from '@digitranslab/model'
import core, { TDoc, TSpace } from '@digitranslab/model-core'
import textEditor from '@digitranslab/model-text-editor'
import tracker from '@digitranslab/model-tracker'
import view, { createAction } from '@digitranslab/model-view'
import { type IntlString, type Resource } from '@digitranslab/platform'
...
import type {
  ...
  TemplateFieldFunc
} from '@digitranslab/templates'
import templates from './plugin'

export { templatesId } from '@digitranslab/templates'
