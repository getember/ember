...
import { type SettingsCategory } from '@digitranslab/setting'
import { templatesId } from '@digitranslab/templates'
import templates from '@digitranslab/templates-resources/src/plugin'

import { type RefInputAction, type RefInputActionItem } from '@digitranslab/model-text-editor'
