...
import notification, { type NotificationType } from '@digitranslab/notification'
import { type Asset, type IntlString } from '@digitranslab/platform'
import type { BuildModelKey, Viewlet, ViewletDescriptor } from '@digitranslab/view'
import questions from '@digitranslab/model-questions'
...
import print from '@digitranslab/model-print'
import setting, { getRoleAttributeProps } from '@digitranslab/setting'
import {
  type Training,
...
import { AccountRole, type Data, type FindOptions, type Permission, type Ref } from '@digitranslab/core'
import { Prop, type Builder } from '@digitranslab/model'

import contacts from '@digitranslab/model-contact'
import core from '@digitranslab/model-core'
import view, { classPresenter, createAction } from '@digitranslab/model-view'
...
export { trainingId } from '@digitranslab/training/src/index'
