...
import core, { type Doc } from '@digitranslab/core'
...
import serverView, { type ServerLinkIdProvider } from '@digitranslab/server-view'

export { serverViewId } from '@digitranslab/server-view'
