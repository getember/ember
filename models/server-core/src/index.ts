...
import { Mixin, Model, type Builder } from '@digitranslab/model'
import { TClass, TDoc } from '@digitranslab/model-core'
import type { Resource } from '@digitranslab/platform'

import core, { DOMAIN_MODEL } from '@digitranslab/core'
import type {
...
export { serverCoreId } from '@digitranslab/server-core'
