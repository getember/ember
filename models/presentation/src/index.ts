...
import { DOMAIN_MODEL, type Tx, type Blob, type Class, type Doc, type Ref } from '@digitranslab/core'
import { Mixin, Model, Prop, TypeRef, TypeString, type Builder } from '@digitranslab/model'
import core, { TClass, TDoc } from '@digitranslab/model-core'
import { type Asset, type IntlString, type Resource } from '@digitranslab/platform'
...
} from '@digitranslab/presentation/src/pipeline'
import {
  type BlobMetadata,
...
} from '@digitranslab/presentation/src/types'
import { type AnyComponent, type ComponentExtensionId } from '@digitranslab/ui/src/types'
import presentation from './plugin'

export { presentationId } from '@digitranslab/presentation/src/plugin'
