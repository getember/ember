//
// Copyright © 2022, 2023, 2024 Digitrans Inc.
//
...
import type { Class, CollectionSize, MarkupBlobRef, Domain, Rank, Role, RolesAssignment } from '@digitranslab/core'
import { Account, AccountRole, IndexKind, Ref } from '@digitranslab/core'
import {
  type Document,
...
import core, { TDoc, TTypedSpace } from '@digitranslab/model-core'
import { createPublicLinkAction } from '@digitranslab/model-guest'
...
import view, { actionTemplates, createAction } from '@digitranslab/model-view'
import workbench from '@digitranslab/model-workbench'
import notification from '@digitranslab/notification'
import { type Asset, getEmbeddedLabel } from '@digitranslab/platform'
import tags from '@digitranslab/tags'
import time, { type ToDo, type Todoable } from '@digitranslab/time'
import document from './plugin'

export { documentId } from '@digitranslab/document'
