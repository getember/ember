...
import { type DocumentSnapshot, type Document, type Teamspace } from '@digitranslab/document'
import {
  migrateSpaceRanks,
  tryMigrate,
...
import { DOMAIN_ACTIVITY } from '@digitranslab/model-activity'
import core, { DOMAIN_SPACE } from '@digitranslab/model-core'
import { DOMAIN_NOTIFICATION } from '@digitranslab/notification'
import { type Asset } from '@digitranslab/platform'
import { makeRank } from '@digitranslab/rank'

import { loadCollabYdoc, saveCollabYdoc, yDocCopyXmlField } from '@digitranslab/collaboration'
