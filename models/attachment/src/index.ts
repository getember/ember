...
import type { Attachment, AttachmentMetadata, Drawing, Photo, SavedAttachments } from '@digitranslab/attachment'
import { IndexKind, type Blob, type Class, type Doc, type Domain, type Ref } from '@digitranslab/core'
import {
  Hidden,
  Index,
  Model,
...
export { attachmentId } from '@digitranslab/attachment'
