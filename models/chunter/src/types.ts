...
import core, { TAttachedDoc, TClass, TDoc, TSpace } from '@digitranslab/model-core'
import type {
  Channel,
  ChatMessage,
  ChatMessageViewlet,
...
import contact, { type ChannelProvider as SocialChannelProvider, type Person } from '@digitranslab/contact'
import activity, { type ActivityMessage } from '@digitranslab/activity'
import { TActivityMessage } from '@digitranslab/model-activity'
