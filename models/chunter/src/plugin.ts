...
import type { ActivityMessage } from '@digitranslab/activity'
import { chunterId, type Channel } from '@digitranslab/chunter'
import chunter from '@digitranslab/chunter-resources/src/plugin'
...
import type { AnyComponent, Location } from '@digitranslab/ui/src/types'
import type { Action, ActionCategory, ViewAction, Viewlet, ViewletDescriptor } from '@digitranslab/view'
import { type WidgetTab, type LocationData } from '@digitranslab/workbench'
