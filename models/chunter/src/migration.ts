...
import { chunterId, type DirectMessage, type ThreadMessage } from '@digitranslab/chunter'
import core, {
  type Account,
  TxOperations,
  type Class,
...
import activity, { migrateMessagesSpace, DOMAIN_ACTIVITY } from '@digitranslab/model-activity'
import notification from '@digitranslab/notification'
import contactPlugin, { type Person, type PersonAccount } from '@digitranslab/contact'
import { DOMAIN_DOC_NOTIFY, DOMAIN_NOTIFICATION } from '@digitranslab/model-notification'
import { type DocUpdateMessage } from '@digitranslab/activity'
