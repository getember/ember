...
import view, { actionTemplates as viewTemplates, createAction, template } from '@digitranslab/model-view'
import notification, { notificationActionTemplates } from '@digitranslab/model-notification'
