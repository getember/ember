...
import { AccountRole, DOMAIN_MODEL, type Account, type Blob, type Domain, type Ref } from '@digitranslab/core'
import { Mixin, Model, UX, type Builder } from '@digitranslab/model'
import core, { TClass, TConfiguration, TDoc } from '@digitranslab/model-core'
...
} from '@digitranslab/setting'
import templates from '@digitranslab/templates'
import setting from './plugin'

import workbench, { WidgetType } from '@digitranslab/model-workbench'
import { type AnyComponent } from '@digitranslab/ui/src/types'

export { settingId } from '@digitranslab/setting'
