...
import contact, { type Channel, type Person, type PersonAccount } from '@digitranslab/contact'
import core, {
  DOMAIN_MODEL_TX,
  type TxCUD,
  type TxCreateDoc,
...
import { DOMAIN_CHANNEL, DOMAIN_CONTACT } from '@digitranslab/model-contact'
import {
  tryMigrate,
