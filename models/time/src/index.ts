...
import board from '@digitranslab/board'
import calendarPlugin, { type Visibility } from '@digitranslab/calendar'
import contactPlugin, { type Person } from '@digitranslab/contact'
import {
  DOMAIN_MODEL,
  type Class,
  type Domain,
...
import lead from '@digitranslab/lead'
import {
  Collection,
  Mixin,
  Model,
...
import textEditor from '@digitranslab/text-editor'
import { TEvent } from '@digitranslab/model-calendar'
import core, { TAttachedDoc, TClass, TDoc, TType } from '@digitranslab/model-core'
import tracker from '@digitranslab/model-tracker'
import document from '@digitranslab/model-document'
...
import recruit from '@digitranslab/recruit'
...
import {
  ...
  type WorkSlot
} from '@digitranslab/time'

import type { Resource } from '@digitranslab/platform'
import type { Rank } from '@digitranslab/task'
import time from './plugin'
import task from '@digitranslab/task'

export { timeId } from '@digitranslab/time'
