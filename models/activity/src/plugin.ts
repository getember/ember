...
//
import { activityId, type ActivityMessage, type DocUpdateMessageViewlet } from '@digitranslab/activity'
import activity from '@digitranslab/activity-resources/src/plugin'
