...
import contact, { type Person } from '@digitranslab/contact'
import core, {
  DOMAIN_MODEL,
  IndexKind,
  type Account,
...
import { TAttachedDoc, TClass, TDoc } from '@digitranslab/model-core'
...
export { activityId } from '@digitranslab/activity'
