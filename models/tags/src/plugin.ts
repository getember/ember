...
import { type TagCategory, tagsId } from '@digitranslab/tags'
import tags from '@digitranslab/tags-resources/src/plugin'
import type { AnyComponent } from '@digitranslab/ui/src/types'
import { type ViewAction } from '@digitranslab/model-view'
