...
import { type Contact, type Employee } from '@digitranslab/contact'
import {
  AccountRole,
  DOMAIN_MODEL,
  IndexKind,
...
import contact, { TEmployee, TPersonAccount } from '@digitranslab/model-contact'
import core, { TAttachedDoc, TDoc, TType } from '@digitranslab/model-core'
...
import { PaletteColorIndexes } from '@digitranslab/ui/src/colors'
import hr from './plugin'

export { hrId } from '@digitranslab/hr'
