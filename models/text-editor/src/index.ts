...
import { DOMAIN_MODEL } from '@digitranslab/core'
import { type Builder, Model } from '@digitranslab/model'
...
} from '@digitranslab/text-editor'
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import type { EditorKitOptions } from '@digitranslab/text-editor-resources'
import textEditor from './plugin'

export { textEditorOperation } from './migration'
export { default } from './plugin'
export { textEditorId } from '@digitranslab/text-editor'
