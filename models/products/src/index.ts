...
import documents, { TExternalSpace, TProject } from '@digitranslab/model-controlled-documents'
import type { Document } from '@digitranslab/controlled-documents'
import type { Product, ProductVersionState, ProductVersion } from '@digitranslab/products'
...
import { getRoleAttributeProps } from '@digitranslab/setting'
import type { Type, CollectionSize, Markup, Arr, RolesAssignment, Permission, Role } from '@digitranslab/core'
import { IndexKind, Ref, Account } from '@digitranslab/core'
import {
  type Builder,
  Model,
  Prop,
...
import core, { TType } from '@digitranslab/model-core'
...
import { getEmbeddedLabel, type Asset } from '@digitranslab/platform'

import products from './plugin'
import { roles } from './roles'

export { productsId } from '@digitranslab/products/src/index'
