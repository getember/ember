...
import { DOMAIN_TX, type MeasureContext, type Ref, type WorkspaceId } from '@digitranslab/core'
import { DOMAIN_ATTACHMENT } from '@digitranslab/model-attachment'
import contact, { DOMAIN_CHANNEL } from '@digitranslab/model-contact'
import { DOMAIN_TELEGRAM } from '@digitranslab/model-telegram'
...
import telegram, { type SharedTelegramMessage, type SharedTelegramMessages } from '@digitranslab/telegram'
