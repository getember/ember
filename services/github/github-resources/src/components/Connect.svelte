...
<script lang="ts">
  ...
  import { WithLookup, getCurrentAccount } from '@digitranslab/core'
  import { GithubAuthentication, GithubIntegration } from '@digitranslab/github'
  import { getEmbeddedLabel, getMetadata, translate } from '@digitranslab/platform'
  import presentation, { Card, HTMLViewer, NavLink, createQuery } from '@digitranslab/presentation'
  import { Integration } from '@digitranslab/setting'
  import tracker, { Project } from '@digitranslab/tracker'
  import ui, { Button, Label, Loading, TabItem, TabList, location, ticker } from '@digitranslab/ui'
