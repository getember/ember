<script lang="ts">
  ...
  import { NavLink, createQuery, getClient, isAdminUser } from '@digitranslab/presentation'
  import { Issue } from '@digitranslab/tracker'
  import { ButtonKind, showPopup } from '@digitranslab/ui'
  import Button from '@digitranslab/ui/src/components/Button.svelte'
  import Icon from '@digitranslab/ui/src/components/Icon.svelte'
  import { DocSyncInfo, GithubIntegrationRepository, GithubProject } from '@digitranslab/github'
