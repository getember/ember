...
<script lang="ts">
  ...
  import type { ButtonKind, ButtonShape, ButtonSize, LabelAndProps, SelectPopupValueType } from '@digitranslab/ui'
  import { ButtonWithDropdown, Icon, IconDropdown, SelectPopup, eventToHTMLElement, showPopup } from '@digitranslab/ui'
  import { GithubIntegrationRepository, GithubProject } from '@digitranslab/github'
