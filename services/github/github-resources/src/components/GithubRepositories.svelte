<script lang="ts">
  import { AttachedDoc, Ref, WithLookup } from '@digitranslab/core'
  import { GithubIntegration, GithubIntegrationRepository, GithubProject } from '@digitranslab/github'
  import { getMetadata } from '@digitranslab/platform'
  import presentation, { NavLink, getClient, isAdminUser } from '@digitranslab/presentation'
  import MessageBox from '@digitranslab/presentation/src/components/MessageBox.svelte'
  ...
  import { ObjectPresenter } from '@digitranslab/view-resources'
