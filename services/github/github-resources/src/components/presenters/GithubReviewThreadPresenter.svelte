...
-->
<script lang="ts">
  import core, { Account, Ref, WithLookup, getCurrentAccount } from '@digitranslab/core'
  import { GithubPullRequest, GithubReviewComment, GithubReviewThread } from '@digitranslab/github'
  ...
  import { EmployeePresenter, personAccountByIdStore, personByIdStore } from '@digitranslab/contact-resources'
  ...
  import { Button, Component, Label, PaletteColorIndexes, getPlatformColor, themeStore } from '@digitranslab/ui'
  import diffview from '@digitranslab/diffview'
