<script lang="ts">
  ...
  import { AnySvelteComponent, Icon, Label, PaletteColorIndexes, getPlatformColor, themeStore } from '@digitranslab/ui'
  import { GithubReviewDecisionState } from '@digitranslab/github'
