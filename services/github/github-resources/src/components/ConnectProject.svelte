<script lang="ts">
  ...
  import core, { ClassifierKind, Ref, WithLookup, generateId } from '@digitranslab/core'
  import { getEmbeddedLabel, getMetadata, translate } from '@digitranslab/platform'
  import { getClient } from '@digitranslab/presentation'
  import task, { TaskType, updateProjectType, type TaskStatusFactory } from '@digitranslab/task'
  import tracker, { Project, createStatesData } from '@digitranslab/tracker'
  import ui, {
    Button,
    IconChevronDown,
    PaletteColorIndexes,
  ...
  import DropdownLabelsPopup from '@digitranslab/ui/src/components/DropdownLabelsPopup.svelte'
  import { GithubIntegration, GithubIntegrationRepository, githubPullRequestStates } from '@digitranslab/github'
