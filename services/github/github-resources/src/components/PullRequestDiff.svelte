...
<script lang="ts">
  ...
  import { getCurrentAccount } from '@digitranslab/core'
  import { createQuery, getClient, getFileUrl } from '@digitranslab/presentation'
  import { Button, Chevron, Component, ExpandCollapse, Label } from '@digitranslab/ui'
  import diffview from '@digitranslab/diffview'
  import { GithubPatch, GithubPullRequest, GithubPullRequestReview } from '@digitranslab/github'
