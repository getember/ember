...
import core, { Doc, DocData, DocumentUpdate, MeasureContext, TxOperations, generateId } from '@digitranslab/core'
import github, { DocSyncInfo, GithubIntegrationRepository, GithubProject } from '@digitranslab/github'
...
export class RepositorySyncMapper implements DocSyncManager {
  ...
  async handleRepoRename (
    ...
    /**
     Variants:
     "https://api.github.com/repos/digitranslab/anticrm/issues/comments/1679316918"
     "https://github.com/digitranslab/uberflow/pull/195"
     * */
