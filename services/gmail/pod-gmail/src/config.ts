...
const config: Config = (() => {
  const params: Partial<Config> = {
    ...
    SystemEmail: process.env[envMap.SystemEmail] ?? 'anticrm@digitrans.lab',
    ...
    FooterMessage: process.env[envMap.FooterMessage] ?? '<br><br><p>Sent via <a href="https://ember.io">Efficio</a></p>'
  }
