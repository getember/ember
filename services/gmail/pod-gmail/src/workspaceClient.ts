...
import contact, { type Employee, type PersonAccount, type Channel as PlatformChannel } from '@digitranslab/contact'
import core, {
  type Account,
  type Client,
  type Doc,
...
import gmailP, { type NewMessage } from '@digitranslab/gmail'
